...
$lang['FormRules.nonmerchantfields.fields[][label].empty'] = 'Insira uma etiqueta para cada campo.';
$lang['FormRules.nonmerchantfields.fields[][name].format'] = 'Insira um nome para cada campo no formato snake_case_name.';
...
$lang['FormRules.nonmerchantbasic.authors[][name].empty'] = 'Insira um nome para cada autor.';
$lang['FormRules.merchantfields.fields[][type].valid'] = 'Um ou mais campos têm um tipo inválido.';
$lang['FormRules.merchantfields.fields[][label].empty'] = 'Insira uma etiqueta para cada campo.';
$lang['FormRules.merchantfields.fields[][name].format'] = 'Insira um nome para cada campo no formato snake_case_name.';
...
$lang['FormRules.merchantbasic.authors[][name].empty'] = 'Insira um nome para cada autor.';
...
$lang['FormRules.pluginintegrations.events[][event].empty'] = 'Insira um nome de evento para cada evento.';
$lang['FormRules.pluginintegrations.actions[][name].empty'] = 'Insira um nome para cada ação.';
$lang['FormRules.pluginintegrations.actions[][action].format'] = 'Insira uma ação para cada ação em letras minúsculas.';
...
$lang['FormRules.pluginintegrations.actions[][location].valid'] = 'Insira um local de ação válido.';
...
$lang['FormRules.plugindatabase.tables[][columns][][name].format'] = 'Insira um nome de método para cada coluna no formato snake_case_name.';
$lang['FormRules.plugindatabase.tables[][name].format'] = 'Insira um nome de método para cada tabela no formato snake_case_name.';
$lang['FormRules.pluginbasic.authors[][name].empty'] = 'Insira um nome para cada autor.';
$lang['FormRules.modulefeatures.cron_tasks[][time].format'] = 'Insira uma hora no formato 00:00 ou um intervalo numérico.';
$lang['FormRules.modulefeatures.cron_tasks[][type].valid'] = 'Uma ou mais tarefas cron têm um tipo inválido.';
$lang['FormRules.modulefeatures.cron_tasks[][label].empty'] = 'Insira uma etiqueta para cada tarefa do cron.';
$lang['FormRules.modulefeatures.cron_tasks[][name].format'] = 'Insira um nome de método para cada tarefa cron no formato snake_case_name.';
$lang['FormRules.modulefeatures.service_tabs[][level].valid'] = 'Uma ou mais guias de serviço têm um nível inválido.';
$lang['FormRules.modulefeatures.service_tabs[][label].empty'] = 'Insira uma etiqueta para cada guia de serviço.';
$lang['FormRules.modulefeatures.service_tabs[][method_name].format'] = 'Insira um nome de método para cada guia de serviço no formato camelCaseName.';
...
$lang['FormRules.modulefields.package_fields[][label].empty'] = 'Insira uma etiqueta para cada campo do pacote.';
$lang['FormRules.modulefields.package_fields[][name].format'] = 'Insira um nome para cada campo de pacote no formato snake_case_name.';
...
$lang['FormRules.modulefields.service_fields[][label].empty'] = 'Insira uma etiqueta para cada campo de serviço.';
$lang['FormRules.modulefields.service_fields[][name].format'] = 'Insira um nome para cada campo de serviço no formato snake_case_name.';
...
$lang['FormRules.modulefields.module_rows[][label].empty'] = 'Insira uma etiqueta para cada campo de linha do módulo.';
$lang['FormRules.modulefields.module_rows[][name].format'] = 'Insira um nome para cada campo de linha do módulo no formato snake_case_name.';
$lang['FormRules.modulebasic.authors[][name].empty'] = 'Insira um nome para cada autor.';
$lang['FormRules.modulebasic.module_group.empty'] = 'Insira uma etiqueta de grupo de módulos.';
$lang['FormRules.modulebasic.module_row_plural.empty'] = 'Adicione um nome de linha de módulo no plural.';
$lang['FormRules.modulebasic.module_row.empty'] = 'Insira um nome de linha de módulo.';
