...
$lang['FormRules.modulefields.package_fields[][name_key].valid'] = '是否将套餐字段设置为名称键，必须设置为 true 或 false。';
$lang['FormRules.modulefields.package_fields[][type].valid'] = '一个或多个套餐字段的类型无效。';
$lang['FormRules.modulefields.package_fields[][label].empty'] = '请为每个包件字段输入一个标签。';
$lang['FormRules.modulefields.package_fields[][name].format'] = '请为每个套餐字段输入一个名称，格式为 snake_case_name。';
