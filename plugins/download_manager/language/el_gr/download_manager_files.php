...
$lang['DownloadManagerFiles.!error.file_groups.format'] = 'Τουλάχιστον μία επιλεγμένη ομάδα πελατών δεν μπορεί να προστεθεί επειδή δεν υπάρχει.';
$lang['DownloadManagerFiles.!error.permit_packages.format'] = 'Η επιλογή διαθεσιμότητας πακέτου έχει μη έγκυρη μορφή.';
$lang['DownloadManagerFiles.!error.file_packages.format'] = 'Τουλάχιστον ένα επιλεγμένο πακέτο δεν μπορεί να προστεθεί επειδή δεν υπάρχει.';
$lang['DownloadManagerFiles.!error.file_id.exists'] = 'Το αρχείο που ενημερώνεται δεν υπάρχει.';
