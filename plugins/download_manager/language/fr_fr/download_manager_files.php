...
$lang['DownloadManagerFiles.!error.file_groups.format'] = 'Au moins un groupe de clients sélectionné ne peut être ajouté car il n\'existe pas.';
$lang['DownloadManagerFiles.!error.permit_packages.format'] = 'Le format de l\'option de disponibilité du paquet n\'est pas valide.';
$lang['DownloadManagerFiles.!error.file_packages.format'] = 'Au moins un paquet sélectionné ne peut être ajouté car il n\'existe pas.';
$lang['DownloadManagerFiles.!error.file_id.exists'] = 'Le fichier en cours de mise à jour n\'existe pas.';
