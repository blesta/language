...
$lang['DownloadManagerFiles.!error.file_id.exists'] = 'Файл, який оновлюється, не існує.';
$lang['DownloadManagerFiles.!error.file_packages.format'] = 'Принаймні один з обраних пакунків не може бути доданий, оскільки він не існує.';
$lang['DownloadManagerFiles.!error.permit_packages.format'] = 'Параметр доступності пакета має невірний формат.';
$lang['DownloadManagerFiles.!error.file_groups.format'] = 'Принаймні одну обрану групу клієнтів не можна додати, оскільки вона не існує.';
