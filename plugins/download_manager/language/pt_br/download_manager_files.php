...
$lang['DownloadManagerFiles.!error.file_id.exists'] = 'O arquivo que está sendo atualizado não existe.';
...
$lang['DownloadManagerFiles.!error.permit_packages.format'] = 'A opção de disponibilidade do pacote está em um formato inválido.';
