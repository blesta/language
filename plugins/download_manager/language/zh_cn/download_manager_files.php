...
$lang['DownloadManagerFiles.!error.public.format'] = '公共可用性选项的格式无效。';
$lang['DownloadManagerFiles.!error.file_name.format'] = '请上传文件或输入上传目录中文件的有效路径。';
$lang['DownloadManagerFiles.!error.name.empty'] = '请为该文件输入名称。';
$lang['DownloadManagerFiles.!error.company_id.exists'] = '公司 ID 无效。';
$lang['DownloadManagerFiles.!error.category_id.exists'] = '请选择一个有效的类别。';
