...
$lang['AdminMain.index.text_description_outgoing'] = 'Envia uma solicitação HTTP para um URL quando um evento é acionado. A solicitação pode ser enviada usando GET, POST ou JSON.';
