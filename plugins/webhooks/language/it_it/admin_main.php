...
$lang['AdminMain.index.text_description_outgoing'] = 'Invia una richiesta HTTP a un URL quando viene attivato un evento. La richiesta può essere inviata tramite GET, POST o JSON.';
