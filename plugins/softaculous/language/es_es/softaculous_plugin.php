...
$lang['SoftaculousPlugin.remote_curl_error'] = 'No se ha podido iniciar sesión en el servidor remoto. cURL Error: %1$s';
$lang['SoftaculousPlugin.remote_firewall_error'] = 'No se pudo determinar la ubicación del Softaculous en el servidor remoto. Podría haber un cortafuegos impidiendo el acceso.';
$lang['SoftaculousPlugin.script_selected_error'] = 'No se ha podido determinar el script a instalar. Por favor, asegúrese de que el nombre del script es correcto. Nombre del script: %1$s';
$lang['SoftaculousPlugin.script_installed'] = 'Script instalado correctamente';
$lang['SoftaculousPlugin.script_no_installed'] = 'No se ha podido instalar el script: %1$s';
