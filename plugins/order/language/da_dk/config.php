...
$lang['Config.!error.invalid_value_option'] = 'Der skal vælges en værdi for %1$s.';
$lang['Config.!error.invalid_quantity_option'] = 'Indstillingsværdien "%1$s" skal være mellem %2$s og %3$s.';
$lang['Config.index.package_price_recurring_breakdown_savings'] = '%1$s %2$s (fornyer %3$s) (%4$s/mo %5$s%% besparelse!) ';
$lang['Config.index.package_price_breakdown_savings'] = '%1$s %2$s (%3$s/mo %4$s%% besparelse!)';
$lang['Config.index.package_price_recurring_breakdown'] = '%1$s %2$s (fornyer %3$s) (%4$s/mo) ';
