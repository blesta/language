...
$lang['DomainsFeed.getOptionFields.header_description'] = 'Περιγραφή';
$lang['DomainsFeed.getOptionFields.params'] = 'Παράμετροι';
$lang['DomainsFeed.getOptionFields.param_currency'] = 'νόμισμα';
$lang['DomainsFeed.getOptionFields.param_currency_description'] = 'Ο κωδικός νομίσματος 3 χαρακτήρων για τον οποίο θα αντληθεί η τιμολόγηση.';
...
$lang['DomainsFeed.table.register'] = 'Εγγραφή';
$lang['DomainsFeed.table.transfer'] = 'Μεταφορά';
$lang['DomainsFeed.table.renew'] = 'Ανανέωση';
