...
$lang['DomainsFeed.description'] = 'Devuelve una tabla HTML que contiene los precios de todos los TLD o el número de dominios registrados.';
...
$lang['DomainsFeed.getOptionFields.param_tlds_description'] = 'Una lista separada por comas de TLDS (excluyendo el punto inicial), para filtrar dominios.';
$lang['DomainsFeed.getOptionFields.param_status_description'] = 'El estado por el que filtrar los dominios: activo, cancelado o pendiente.';
$lang['DomainsFeed.getOptionFields.example_code_count'] = 'Muestra el número de dominios registrados:';
$lang['DomainsFeed.getOptionFields.example_code_pricing'] = 'Mostrar una tabla con los precios de todos los TLD en una moneda determinada:';
