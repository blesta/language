...
$lang['AdminDomains.!success.queue_sync'] = '¡Los dominios seleccionados se han puesto en cola para su sincronización!';
...
$lang['AdminDomains.!warning.tld_sync_currencies'] = 'No se han sincronizado los precios. Selecciona al menos una moneda para sincronizar los precios.';
$lang['AdminDomains.!warning.tld_sync_tlds'] = 'No se han sincronizado los precios. Selecciona al menos un TLD para sincronizar los precios.';
...
$lang['AdminDomains.browse.heading_options'] = 'Acciones';
...
$lang['AdminDomains.browse.text_item_selected'] = 'elemento seleccionado';
$lang['AdminDomains.browse.text_items_selected'] = 'artículos seleccionados';
...
$lang['AdminDomains.configurableoptions.heading_options'] = 'Acciones';
...
$lang['AdminDomains.configuration.btn_add_spotlight_tlds'] = 'Añadir TLDs Spotlight';
$lang['AdminDomains.configuration.btn_cancel'] = 'Cancelar';
$lang['AdminDomains.configuration.btn_close'] = 'Cerrar';
$lang['AdminDomains.configuration.btn_done'] = 'Hecho';
$lang['AdminDomains.configuration.btn_edit'] = 'Editar';
$lang['AdminDomains.configuration.btn_save_changes'] = 'Guardar cambios';
...
$lang['AdminDomains.configuration.field_migrate_services'] = 'Servicios de migración';
$lang['AdminDomains.configuration.field_override_price'] = 'Fijar los precios de los dominios';
$lang['AdminDomains.configuration.field_overwrite_tld_packages'] = 'Sobrescribir paquetes TLD';
...
$lang['AdminDomains.configuration.heading_actions'] = 'Acciones';
$lang['AdminDomains.configuration.heading_automation'] = 'Automatización';
$lang['AdminDomains.configuration.heading_configurable_option'] = 'Opción configurable';
$lang['AdminDomains.configuration.heading_expiration_reminders'] = 'Recordatorios de caducidad';
$lang['AdminDomains.configuration.heading_import_options'] = 'Opciones de importación';
...
$lang['AdminDomains.configuration.heading_price'] = 'Precio';
$lang['AdminDomains.configuration.heading_renewal_price'] = 'Precio de renovación';
$lang['AdminDomains.configuration.heading_renewal_settings'] = 'Ajustes de renovación';
$lang['AdminDomains.configuration.heading_spotlight_tlds'] = 'TLD destacados';
$lang['AdminDomains.configuration.heading_taxes'] = 'Impuestos';
$lang['AdminDomains.configuration.heading_term'] = 'Plazo';
$lang['AdminDomains.configuration.link_template'] = 'Editar plantilla de correo electrónico';
$lang['AdminDomains.configuration.modal_edit_configurable_option'] = 'Editar opción configurable';
$lang['AdminDomains.configuration.modal_select_spotlight_tlds'] = 'Seleccionar TLD destacados';
$lang['AdminDomains.configuration.modal_select_up_to_8'] = 'Elija hasta 8 TLD';
$lang['AdminDomains.configuration.option_dns_management'] = 'Gestión de DNS';
$lang['AdminDomains.configuration.option_email_forwarding'] = 'Reenvío de correo electrónico';
$lang['AdminDomains.configuration.option_id_protection'] = 'Protección ID';
$lang['AdminDomains.configuration.page_title'] = 'Dominios > Configuración';
$lang['AdminDomains.configuration.placeholder_search_tlds'] = 'Buscar TLDs...';
$lang['AdminDomains.configuration.tab_advanced'] = 'Avanzado';
$lang['AdminDomains.configuration.tab_configurable_options'] = 'Opciones configurables';
...
$lang['AdminDomains.configuration.tab_import_packages'] = 'Importar paquetes';
...
$lang['AdminDomains.configuration.text_import_bullet_1'] = 'Buscar todos los paquetes asignados a un módulo registrador (es posible que los módulos de terceros no se identifiquen como registradores y, por tanto, no se reconozcan).';
$lang['AdminDomains.configuration.text_import_bullet_2'] = 'Para cada TLD asignado al paquete, cree un nuevo paquete de precios de TLD con los mismos detalles en el Administrador de dominios';
$lang['AdminDomains.configuration.text_import_bullet_3'] = 'Omitir cualquier paquete/TLD con el mismo registrador que un paquete/TLD encontrado anteriormente.';
$lang['AdminDomains.configuration.text_import_bullet_4'] = 'Omita los paquetes sin periodos de tarificación anuales';
$lang['AdminDomains.configuration.text_import_bullet_5'] = 'Marque el primer paquete/registrador encontrado para cada TLD como el principal, mientras que los demás paquetes de importación se utilizarán cuando se cambie el registrador en la página Precios de TLD.';
$lang['AdminDomains.configuration.text_import_bullet_6'] = 'Desactivar los antiguos paquetes importados si no tienen servicios después de la importación.';
$lang['AdminDomains.configuration.text_import_will'] = 'Esta importación lo hará:';
...
$lang['AdminDomains.configuration.text_spotlight_description'] = 'Seleccione hasta 8 TLDs para destacar durante el pedido del dominio.';
...
$lang['AdminDomains.configuration.tooltip_enable_rounding'] = 'Redondea los precios a la cantidad especificada más cercana.';
...
$lang['AdminDomains.configuration.tooltip_migrate_services'] = 'Si se selecciona esta opción, todos los servicios asignados a los paquetes clonados se migrarán a los paquetes recién creados. Esto solo se aplicará a los servicios con un periodo de tarificación anual.';
...
$lang['AdminDomains.configuration.tooltip_overwrite_tld_packages'] = 'Si se selecciona esta opción, se eliminarán los paquetes TLD actuales del Administrador de Dominios y se sustituirán por paquetes TLD externos. Los paquetes del Administrador de Dominios con servicios asignados se omitirán durante este proceso.';
...
$lang['AdminDomains.configuration.tooltip_sync_price_markup'] = 'Porcentaje de recargo aplicado a los precios de registro de dominios.';
$lang['AdminDomains.configuration.tooltip_sync_renewal_markup'] = 'Porcentaje de recargo aplicado a los precios de renovación de dominios.';
$lang['AdminDomains.configuration.tooltip_sync_transfer_markup'] = 'Porcentaje de recargo aplicado a los precios de transferencia de dominios.';
$lang['AdminDomains.configuration.tooltip_taxable'] = 'Aplique los impuestos configurados a las tarifas de registro, renovación y transferencia de dominios.';
...
$lang['AdminDomains.importpackages.alert_point1'] = 'Buscar todos los paquetes asignados a un módulo registrador (es posible que los módulos de terceros no se identifiquen como registradores y, por tanto, no se reconozcan).';
$lang['AdminDomains.importpackages.alert_point2'] = 'Para cada TLD asignado al paquete, cree un nuevo paquete de precios de TLD con los mismos detalles en el Administrador de dominios';
$lang['AdminDomains.importpackages.alert_point3'] = 'Omitir cualquier paquete/TLD con el mismo registrador que un paquete/TLD encontrado anteriormente.';
$lang['AdminDomains.importpackages.alert_point4'] = 'Omita los paquetes sin periodos de tarificación anuales';
$lang['AdminDomains.importpackages.alert_point5'] = 'Marque el primer paquete/registrador encontrado para cada TLD como el principal, mientras que los demás paquetes de importación se utilizarán cuando se cambie el registrador en la página Precios de TLD.';
$lang['AdminDomains.importpackages.alert_point6'] = 'Desactivar los antiguos paquetes importados si no tienen servicios después de la importación.';
$lang['AdminDomains.importpackages.alert_title'] = 'Esta importación lo hará:';
...
$lang['AdminDomains.importpackages.field_refresh'] = 'Actualizar';
...
$lang['AdminDomains.importpackages.section_import_options'] = 'Opciones de importación';
$lang['AdminDomains.importpackages.text_collecting_list_tlds'] = 'Recopilación de una lista de TLD para importar...';
$lang['AdminDomains.importpackages.text_no_tlds_available'] = 'No hay TLD disponibles para importar';
...
$lang['AdminDomains.pricing.field_email_body'] = 'Correo electrónico';
...
$lang['AdminDomains.pricing.placeholder_email_template'] = 'Introduzca su plantilla de correo electrónico de bienvenida...';
...
$lang['AdminDomains.pricing.text_edit_package_description'] = 'Edite el paquete básico para definir los límites de clientes, las opciones configurables, la cantidad disponible, las integraciones de plugins, las descripciones y mucho más.';
...
$lang['AdminDomains.pricing.text_tags_description'] = 'Utilice las siguientes etiquetas en su plantilla de correo electrónico:';
...
$lang['AdminDomains.tlds.heading_options'] = 'Acciones';
...
$lang['AdminDomains.tlds.text_items_selected'] = 'elementos seleccionados';
$lang['AdminDomains.tlds.text_perform'] = 'realizar';
$lang['AdminDomains.tlds.text_set_to'] = 'ajustado a';
...
$lang['AdminDomains.whois.error_invalid_domain'] = 'Introduzca un nombre de dominio válido';
$lang['AdminDomains.whois.field_domain'] = 'Dominio';
$lang['AdminDomains.whois.field_domain_placeholder'] = 'Introduzca el nombre de dominio (por ejemplo, ejemplo.com)';
$lang['AdminDomains.whois.field_submit'] = 'Búsqueda';
$lang['AdminDomains.whois.heading_whois_info'] = 'Información WHOIS';
$lang['AdminDomains.whois.label_dnssec'] = 'DNSSEC';
$lang['AdminDomains.whois.label_exp_date'] = 'Fecha de expiración';
$lang['AdminDomains.whois.label_name_servers'] = 'Servidores de nombres';
$lang['AdminDomains.whois.label_reg_date'] = 'Fecha de inscripción';
...
$lang['AdminDomains.whois.text_description'] = 'Buscar disponibilidad de dominios y ver información WHOIS';
$lang['AdminDomains.whois.text_searching'] = 'Búsqueda de disponibilidad de dominios...';
