...
$lang['Automation.task.deliver_invoices.attempt'] = 'Προσπάθεια παράδοσης τιμολογίων που έχουν προγραμματιστεί για παράδοση.';
$lang['Automation.task.deliver_invoices.completed'] = 'Η εργασία παράδοσης τιμολογίων έχει ολοκληρωθεί.';
$lang['Automation.task.deliver_invoices.delivery_error'] = 'Αδυναμία παράδοσης τιμολογίων %3$s στον πελάτη #%1$s μέσω %2$s λόγω σφάλματος: %4$s';
