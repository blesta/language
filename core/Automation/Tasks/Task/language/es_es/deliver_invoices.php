...
$lang['Automation.task.deliver_invoices.attempt'] = 'Intento de entrega de facturas programadas.';
$lang['Automation.task.deliver_invoices.completed'] = 'La tarea de entrega de facturas ha finalizado.';
$lang['Automation.task.deliver_invoices.delivery_error'] = 'No se han podido entregar %3$s facturas al cliente #%1$s a través de %2$s debido a un error: %4$s';
$lang['Automation.task.deliver_invoices.delivery_error_one'] = 'No se ha podido entregar 1 factura al cliente #%1$s a través de %2$s debido a un error: %3$s';
