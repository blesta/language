...
$lang['PterodactylPackage.package_fields.tooltip.display'] = 'Selecione para permitir que os clientes modifiquem este valor durante a adição ou edição do serviço. Deixe a opção desmarcada se estiver a planear usar uma opção configurável para este campo.';
$lang['PterodactylPackage.package_fields.optional'] = '%1$s (opcional)';
$lang['PterodactylPackage.package_fields.tooltip.backups'] = 'O número total de backups que um utilizador pode fazer para os servidores criados. Deixe vazio para permitir um número ilimitado.';
$lang['PterodactylPackage.package_fields.backups'] = 'Limite de backup (opcional)';
$lang['PterodactylPackage.package_fields.tooltip.allocations'] = 'O número total de alocações que um utilizador tem permissão para criar servidores. Deixe vazio para permitir um número ilimitado.';
$lang['PterodactylPackage.package_fields.allocations'] = 'Limite de alocação (opcional)';
$lang['PterodactylPackage.package_fields.tooltip.databases'] = 'O número total de bases de dados que um utilizador tem permissão para criar servidores. Deixe vazio para permitir um número ilimitado.';
...
$lang['PterodactylPackage.package_fields.pack_id'] = 'ID do pacote (opcional)';
...
$lang['PterodactylPackage.package_fields.tooltip.io'] = 'Número de ajuste de E/S do bloco (10-1000).';
$lang['PterodactylPackage.package_fields.io'] = 'Peso do bloco de E/S';
...
$lang['PterodactylPackage.package_fields.tooltip.egg_id'] = 'ID do Egg a ser usado pelo servidor.';
$lang['PterodactylPackage.package_fields.egg_id'] = 'ID do Egg';
...
$lang['PterodactylPackage.package_fields.tooltip.port_range'] = 'Intervalos de portas separados por vírgulas para atribuir ao servidor (Ex.: 25565-25570,25580-25590).';
...
$lang['PterodactylPackage.package_fields.tooltip.location_id'] = 'O local onde os servidores serão implementados automaticamente.';
...
$lang['PterodactylPackage.!error.meta[io].format'] = 'O peso de E/S deve ser numérico.';
$lang['PterodactylPackage.!error.meta[disk].format'] = 'A quantidade de espaço em disco deve ser numérica.';
$lang['PterodactylPackage.!error.meta[cpu].format'] = 'A percentagem da CPU deve ser numérica.';
...
$lang['PterodactylPackage.!error.meta[egg_id].valid'] = 'O Egg não corresponde a nenhum outro no Pterodactyl.';
$lang['PterodactylPackage.!error.meta[egg_id].format'] = 'A ID do Egg deve ser numérica.';
$lang['PterodactylPackage.!error.meta[nest_id].valid'] = 'O Nest não corresponde a nenhum outro no Pterodactyl.';
$lang['PterodactylPackage.!error.meta[nest_id].format'] = 'A ID do Nest deve ser numérica.';
