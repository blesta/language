...
$lang['PterodactylPackage.package_fields.tooltip.pack_id'] = '要安装服务器的套餐 ID。';
$lang['PterodactylPackage.package_fields.pack_id'] = '套餐 ID（可选）';
...
$lang['PterodactylPackage.!error.meta[pack_id].format'] = '套餐 ID 必须是数字。';
