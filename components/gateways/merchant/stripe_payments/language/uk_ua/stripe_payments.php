...
$lang['StripePayments.!error.ach.invalid_account'] = 'Банківський рахунок цього клієнта не вдалося знайти.';
$lang['StripePayments.!error.ach.unverified'] = 'Не вдалося підтвердити банківський рахунок. Будь ласка, перевірте суми поповнення та спробуйте ще раз.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Будь ласка, введіть дійсну суму для максимального періодичного списання.';
...
$lang['StripePayments.ach_form.mandate_future_usage'] = 'Якщо ви користуєтеся послугами %1$s або періодично купуєте додаткові продукти відповідно до умов, викладених на сайті %1$s, ви надаєте %1$s дозвіл на періодичне списання коштів з вашого банківського рахунку. Платежі, що виходять за межі зазначених вище регулярних списань, будуть списані лише після отримання вашого дозволу.';
$lang['StripePayments.ach_form.verification_notice'] = 'Поточні дані банківського рахунку, що містяться в системі, не пройшли перевірку. Введення нових реквізитів банківського рахунку нижче призведе до їх заміни.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Максимальна сума періодичного списання (Індія)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Необхідно для увімкнення автоматичних періодичних списань з карток, випущених в Індії. Це максимальна сума, яка може бути списана з такої картки під час будь-якого окремого майбутнього платежу поза сесією в валюті, що обробляється. Залиште поле порожнім, щоб дозволити збереження індійських карток без реєстрації для автоматичних періодичних списань.';
...
$lang['StripePayments.text_migrate_accounts'] = 'Ви можете автоматично перенести платіжні рахунки, які зберігаються поза сервером за допомогою старого шлюзу Stripe, на цей шлюз Stripe Payments. Рахунки, які не зберігаються поза сервером, необхідно перенести вручну, створивши нові платіжні рахунки. Щоб уникнути перевищення ліміту часу очікування, перенесення буде здійснюватися партіями за посиланням %1$s. Виконуйте цю команду стільки разів, скільки потрібно, щоб перенести всі платіжні рахунки.';
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'Відповідно до правил Резервного банку Індії (RBI), у разі здійснення повторних (позасесійних) списань з індійських карток на суму, що перевищує зазначену, клієнт повинен буде окремо підтвердити платіж.';
