...
$lang['StripePayments.!error.ach.invalid_account'] = 'לא נמצא חשבון בנק עבור לקוח זה.';
$lang['StripePayments.!error.ach.unverified'] = 'לא ניתן לאמת את חשבון הבנק. אנא אמת את סכומי ההפקדה ונסה שוב.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'אנא הזן סכום תקף עבור החיוב החוזר המקסימלי.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'חשבון הבנק המופיע כרגע בתיק לא אומת. הזנת פרטי חשבון בנק חדשים להלן תחליף את הפרטים הקיימים.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'סכום החיוב החוזר המרבי (הודו)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'נדרש כדי לאפשר חיובים חוזרים אוטומטיים עבור כרטיסים שהונפקו בהודו. זהו הסכום המרבי שניתן לחייב מכרטיס כזה בכל תשלום עתידי מחוץ למפגש, במטבע שבו מתבצע העיבוד. השאר שדה זה ריק כדי לאפשר שמירת כרטיסים הודיים ללא רישום לחיובים חוזרים אוטומטיים.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'על פי תקנות ה-RBI, חיובים חוזרים (מחוץ לשעות הפעילות) בכרטיסי אשראי הודיים העולים על סכום זה יחייבו את הלקוח לאמת את התשלום בנפרד.';
