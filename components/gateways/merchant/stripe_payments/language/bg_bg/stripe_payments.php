...
$lang['StripePayments.!error.ach.invalid_account'] = 'Не беше намерена банкова сметка за този клиент.';
$lang['StripePayments.!error.ach.unverified'] = 'Не беше възможно да се потвърди банковата сметка. Моля, проверете сумите на депозитите и опитайте отново.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Моля, въведете валидна сума за максималната периодична такса.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'Наличната в момента банкова сметка не е потвърдена. Ако въведете новите данни за банковата сметка по-долу, те ще заменят старите.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Максимална сума на периодичните такси (Индия)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Необходимо е, за да се активират автоматичните периодични плащания за карти, издадени в Индия. Това е максималната сума, която може да бъде начислена по такава карта при всяко бъдещо плащане извън сесия, във валутата, в която се извършва транзакцията. Оставете полето празно, за да позволите запазването на индийски карти без регистриране за автоматични периодични плащания.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'Съгласно разпоредбите на RBI, при периодични (извън сесия) транзакции с индийски карти, надвишаващи тази сума, клиентът ще трябва да удостовери плащането отделно.';
