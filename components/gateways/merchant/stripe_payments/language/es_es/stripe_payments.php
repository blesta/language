...
$lang['StripePayments.!error.ach.invalid_account'] = 'No se ha podido encontrar la cuenta bancaria de este cliente.';
$lang['StripePayments.!error.ach.unverified'] = 'No se ha podido verificar la cuenta bancaria. Por favor, comprueba los importes de los ingresos e inténtalo de nuevo.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Introduce un importe válido para el cargo periódico máximo.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'La cuenta bancaria que figura actualmente en nuestros registros no ha sido verificada. Si introduces los datos de una nueva cuenta bancaria a continuación, se sustituirá por esta.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Importe máximo de los cargos recurrentes (India)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Es obligatorio para habilitar los cobros periódicos automáticos en tarjetas emitidas en la India. Este es el importe máximo que se podrá cobrar en dicha tarjeta en cualquier pago futuro fuera de sesión, en la divisa en la que se procese la transacción. Déjalo en blanco para permitir que las tarjetas indias se guarden sin necesidad de registrarse para los cobros periódicos automáticos.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'De acuerdo con la normativa del RBI, los cargos recurrentes (fuera de sesión) en tarjetas indias que superen este importe requerirán que el cliente autentifique el pago por separado.';
