...
$lang['StripePayments.!error.ach.invalid_account'] = 'De bankrekening van deze klant kon niet worden gevonden.';
$lang['StripePayments.!error.ach.unverified'] = 'De bankrekening kon niet worden geverifieerd. Controleer de stortingsbedragen en probeer het opnieuw.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Voer een geldig bedrag in voor de maximale periodieke afschrijving.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'De momenteel geregistreerde bankrekening is nog niet geverifieerd. Als u hieronder nieuwe bankgegevens invoert, worden deze in de plaats van de huidige gegevens geplaatst.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Maximaal bedrag aan terugkerende kosten (India)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Vereist om automatische terugkerende afschrijvingen in te schakelen voor kaarten die in India zijn uitgegeven. Dit is het maximumbedrag dat in de toekomst bij elke afzonderlijke betaling buiten de sessie om van een dergelijke kaart mag worden afgeschreven, in de valuta waarin de transactie wordt verwerkt. Laat dit veld leeg om toe te staan dat Indiase kaarten worden opgeslagen zonder dat er een registratie voor automatische terugkerende afschrijvingen plaatsvindt.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'Volgens de voorschriften van de RBI moet de klant bij terugkerende (buiten de transactiesessie plaatsvindende) afschrijvingen op Indiase kaarten die dit bedrag overschrijden, de betaling afzonderlijk verifiëren.';
