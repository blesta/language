...
$lang['StripePayments.!error.ach.invalid_account'] = 'Det gick inte att hitta något bankkonto för denna kund.';
$lang['StripePayments.!error.ach.unverified'] = 'Bankkontot kunde inte verifieras. Kontrollera insättningsbeloppen och försök igen.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Ange ett giltigt belopp för den högsta återkommande avgiften.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'Det bankkonto som för närvarande finns registrerat har inte verifierats. Om du anger nya bankkontouppgifter nedan kommer de att ersätta de befintliga.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Högsta belopp för återkommande avgifter (Indien)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Krävs för att aktivera automatiska återkommande debiteringar för kort utfärdade i Indien. Detta är det högsta belopp som får debiteras ett sådant kort vid en enskild framtida betalning utanför sessionen, i den valuta som behandlas. Lämna fältet tomt för att tillåta att indiska kort sparas utan att registreras för automatiska återkommande debiteringar.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'Enligt RBI:s föreskrifter måste kunden separat bekräfta betalningen vid återkommande (utanför sessionen) debiteringar på indiska kort som överstiger detta belopp.';
