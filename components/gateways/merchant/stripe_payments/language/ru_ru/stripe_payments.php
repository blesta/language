...
$lang['StripePayments.!error.ach.invalid_account'] = 'Банковский счет этого клиента не найден.';
$lang['StripePayments.!error.ach.unverified'] = 'Не удалось подтвердить банковский счет. Пожалуйста, проверьте суммы пополнения и попробуйте ещё раз.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Пожалуйста, введите допустимую сумму для максимального периодического списания.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'Указанные в системе данные банковского счета пока не подтверждены. Ввод новых реквизитов банковского счета ниже приведет к их замене.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Максимальная сумма периодического списания (Индия)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Требуется для включения функции автоматических периодических списаний с карт, выпущенных в Индии. Это максимальная сумма, которая может быть списана с такой карты в рамках любого отдельного будущего платежа, осуществляемого вне сеанса, в валюте, в которой осуществляется обработка. Оставьте поле пустым, чтобы разрешить сохранение индийских карт без регистрации для автоматических периодических списаний.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'В соответствии с правилами Резервного банка Индии (RBI) при регулярных (внесессионных) списаниях с индийских карт на сумму, превышающую указанный лимит, клиенту потребуется отдельно подтвердить платеж.';
...
$lang['StripePayments.webhook_note'] = 'Рекомендуется настроить следующий url в качестве Webhook для событий "payment_intent" и "charge" в вашем аккаунте Stripe.';
