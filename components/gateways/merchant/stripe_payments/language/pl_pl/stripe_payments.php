...
$lang['StripePayments.!error.ach.invalid_account'] = 'Nie udało się znaleźć rachunku bankowego tego klienta.';
$lang['StripePayments.!error.ach.unverified'] = 'Nie udało się zweryfikować konta bankowego. Proszę sprawdzić kwoty wpłat i spróbować ponownie.';
...
$lang['StripePayments.!error.india_mandate_max_amount.format'] = 'Wprowadź prawidłową kwotę maksymalnej opłaty cyklicznej.';
...
$lang['StripePayments.ach_form.verification_notice'] = 'Obecnie zarejestrowane konto bankowe nie zostało zweryfikowane. Wprowadzenie poniżej nowych danych konta bankowego spowoduje jego zastąpienie.';
...
$lang['StripePayments.india_mandate_max_amount'] = 'Maksymalna kwota opłaty cyklicznej (Indie)';
$lang['StripePayments.india_mandate_max_amount_note'] = 'Wymagane w celu włączenia automatycznych płatności cyklicznych dla kart wydanych w Indiach. Jest to maksymalna kwota, jaka może zostać pobrana z takiej karty w ramach jednej przyszłej płatności poza sesją, w walucie, w której realizowana jest transakcja. Pozostaw pole puste, aby umożliwić zapisanie indyjskich kart bez rejestracji w celu korzystania z automatycznych płatności cyklicznych.';
...
$lang['StripePayments.tooltip_india_mandate_max_amount'] = 'Zgodnie z przepisami RBI w przypadku powtarzających się (poza sesją) opłat naliczanych na indyjskie karty, których kwota przekracza tę kwotę, klient będzie musiał osobno potwierdzić płatność.';
