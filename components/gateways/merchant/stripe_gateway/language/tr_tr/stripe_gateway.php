...
$lang['Stripe_gateway.api_key'] = 'API Gizli Anahtarı';
$lang['Stripe_gateway.description'] = 'Bu, Stripe Checkout kullanan eski Stripe ağ geçididir. Stripe hesabınızın "Ödemeleri güvenli olmayan şekilde işle" olarak güncellenmesini gerektirir. Bunun yerine Blesta\'daki Stripe Payments ağ geçidini kullanmanızı öneririz';
$lang['Stripe_gateway.name'] = 'Şerit';
