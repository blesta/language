...
$lang['BtcpayServer.!error.failed.response'] = 'A transação não pôde ser processada.';
$lang['BtcpayServer.!error.payment_method.valid'] = 'Selecione um método de pagamento válido.';
$lang['BtcpayServer.!error.payment.expired'] = 'A transação expirou e não pôde ser processada.';
$lang['BtcpayServer.!error.payment.invalid'] = 'A transação é inválida e não pôde ser processada.';
...
$lang['BtcpayServer.!error.webhook_secret.valid'] = 'Tem de introduzir um Webhook Secret válido.';
$lang['BtcpayServer.buildprocess.submit'] = 'Submeter pagamento';
$lang['BtcpayServer.description'] = 'O BTCPayServer é um gateway de pagamento Bitcoin auto-hospedado e sem taxas.';
$lang['BtcpayServer.meta.api_key'] = 'Chave API';
...
$lang['BtcpayServer.meta.payment_method_store'] = 'Forçar a predefinição da loja conforme configurado no servidor BTCPay.';
...
$lang['BtcpayServer.transaction.speed.high'] = 'Elevado';
$lang['BtcpayServer.transaction.speed.low'] = 'Baixa';
$lang['BtcpayServer.transaction.speed.medium'] = 'Médio';
$lang['BtcpayServer.webhook'] = 'Webhook do servidor BTCPay';
$lang['BtcpayServer.webhook_note'] = 'Antes de começar a usar este gateway, deve configurar o seguinte url como um Webhook no seu servidor BTCPay.';
