...
$lang['Clients.!error.encrypted.format'] = 'Wartość „Encrypted” musi wynosić 0 lub 1.';
...
$lang['Clients.!error.action[].exists'] = 'Nieprawidłowe działanie powiadomienia.';
$lang['Clients.!error.action.exists'] = 'Nieprawidłowe działanie powiadomienia "%1$s".';
$lang['Clients.!error.current_passphrase.valid'] = 'Wprowadzona fraza hasła jest nieprawidłowa.';
$lang['Clients.!error.passphrase_hint.secure'] = 'Wskazówka dotycząca hasła nie może być taka sama jak samo hasło.';
$lang['Clients.!error.passphrase_hint.length'] = 'Długość podpowiedzi do hasła nie może przekraczać 255 znaków.';
$lang['Clients.!error.passphrase_confirm.matches'] = 'Wprowadzone hasła nie są zgodne.';
$lang['Clients.!error.passphrase.length'] = 'Hasło musi składać się z co najmniej 8 znaków.';
$lang['Clients.!error.passphrase.empty'] = 'Wprowadź hasło, aby zaszyfrować tę notatkę.';
