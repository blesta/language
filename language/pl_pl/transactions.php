...
$lang['Transactions.!error.amount.applied'] = 'Kwota transakcji nie może być niższa niż kwota już rozliczona na fakturach. Najpierw należy cofnąć rozliczenie tej transakcji z jednej lub kilku faktur.';
$lang['Transactions.!error.amount.format'] = 'Kwota musi być liczbą.';
$lang['Transactions.!error.amounts.applied'] = 'Nie udało się zastosować wartości „Kwota do zapłaty” do wskazanych faktur. Spróbuj ponownie.';
