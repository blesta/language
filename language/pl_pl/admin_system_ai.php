...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Klucz API został już wygenerowany dla Twojej subskrypcji Blesta AI i nie można go odzyskać. Proszę cofnąć istniejący klucz na stronie „Zarządzaj AI” dla swojej usługi pod adresem account.blesta.com, a następnie spróbować ponownie.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s kredytów za 1 tys. tokenów)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Nazwa użytkownika z serwisu account.blesta.com oraz klucz licencyjny Blesta zostaną wykorzystane do weryfikacji licencji i automatycznego pobrania nowego klucza API Blesta AI. Jeśli klucz został już wygenerowany, przed wydaniem nowego klucza należy go najpierw unieważnić na stronie „Zarządzaj AI” dla danej usługi w serwisie account.blesta.com.';
