...
$lang['Transactions.!error.amount.applied'] = 'Der Transaktionsbetrag darf nicht geringer sein als der bereits auf Rechnungen verrechnete Betrag. Heben Sie die Verrechnung der Transaktion zunächst von einer oder mehreren Rechnungen auf.';
$lang['Transactions.!error.amount.format'] = 'Der Betrag muss eine Zahl sein.';
$lang['Transactions.!error.amounts.applied'] = 'Die Beträge konnten nicht auf die angegebenen Rechnungen angewendet werden. Bitte versuchen Sie es erneut.';
