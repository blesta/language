...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Für Ihr Blesta-AI-Abonnement wurde bereits ein API-Schlüssel generiert, der nicht erneut abgerufen werden kann. Bitte widerrufen Sie den bestehenden Schlüssel auf der Seite „AI verwalten“ für Ihren Dienst unter account.blesta.com und versuchen Sie es anschließend erneut.';
...
$lang['AdminSystemAi.index.degraded_model'] = 'Das derzeit ausgewählte Modell „%1$s “ ist nicht mehr verfügbar. Für KI-Funktionen wird vorübergehend „%2$s “ verwendet. Bitte wählen Sie unten ein neues Standardmodell aus und speichern Sie Ihre Auswahl.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s Credits pro 1.000 Token)';
$lang['AdminSystemAi.index.model_recommended'] = '(Empfohlen)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Ihr Benutzername unter account.blesta.com und Ihr Blesta-Lizenzschlüssel werden verwendet, um Ihre Lizenz zu validieren und automatisch einen neuen Blesta-AI-API-Schlüssel abzurufen. Falls bereits ein Schlüssel generiert wurde, muss dieser zunächst auf der Seite „AI verwalten“ für Ihren Dienst unter account.blesta.com widerrufen werden, bevor ein neuer Schlüssel ausgestellt werden kann.';
