...
$lang['AdminSystemAi.!error.key_already_exists'] = 'تم بالفعل إنشاء مفتاح API لاشتراكك في Blesta AI ولا يمكن استرداده مرة أخرى. يرجى إلغاء المفتاح الحالي من صفحة «إدارة الذكاء الاصطناعي» الخاصة بخدمتك على account.blesta.com، ثم حاول مرة أخرى.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s نقطة لكل 1K توكن)';
...
$lang['AdminSystemAi.modal.text_info'] = 'سيتم استخدام اسم المستخدم الخاص بك على account.blesta.com ومفتاح ترخيص Blesta الخاص بك للتحقق من صحة ترخيصك والحصول تلقائيًا على مفتاح API جديد لـ Blesta AI. إذا كان قد تم إنشاء مفتاح بالفعل، فيجب أولاً إلغاؤه من صفحة «إدارة الذكاء الاصطناعي» الخاصة بخدمتك على account.blesta.com قبل أن يتم إصدار مفتاح جديد.';
