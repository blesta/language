...
$lang['Transactions.!error.amount.applied'] = 'يجب ألا يقل مبلغ المعاملة عن المبلغ الذي تم تخصيصه بالفعل للفواتير. قم أولاً بإلغاء تخصيص المعاملة من فاتورة واحدة أو أكثر.';
$lang['Transactions.!error.amount.format'] = 'يجب أن يكون المبلغ رقماً.';
$lang['Transactions.!error.amounts.applied'] = 'تعذر تطبيق قيم «المبلغ المطلوب دفعه» على الفواتير المحددة. يرجى المحاولة مرة أخرى.';
