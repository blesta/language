...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Une clé API a déjà été générée pour votre abonnement à Blesta AI et ne peut pas être récupérée à nouveau. Veuillez révoquer la clé existante depuis la page « Gérer l\'IA » de votre service sur account.blesta.com, puis réessayez.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s crédits par 1 000 jetons)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Votre identifiant sur account.blesta.com et votre clé de licence Blesta serviront à valider votre licence et à générer automatiquement une nouvelle clé API Blesta AI. Si une clé a déjà été générée, celle-ci doit d\'abord être révoquée depuis la page « Gérer l\'IA » de votre service sur account.blesta.com avant qu\'une nouvelle clé puisse être émise.';
