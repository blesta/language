...
$lang['Transactions.!error.amount.applied'] = 'Le montant de la transaction ne peut pas être inférieur au montant déjà imputé aux factures. Commencez par annuler l\'imputation de la transaction sur une ou plusieurs factures.';
$lang['Transactions.!error.amount.format'] = 'Le montant doit être un nombre.';
$lang['Transactions.!error.amounts.applied'] = 'Les montants à payer n\'ont pas pu être appliqués aux factures indiquées. Veuillez réessayer.';
