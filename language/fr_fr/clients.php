...
$lang['Clients.!error.current_passphrase.valid'] = 'Le mot de passe saisi n\'est pas valide.';
...
$lang['Clients.!error.encrypted.format'] = 'La valeur de « Encrypted » doit être 0 ou 1.';
...
$lang['Clients.!error.passphrase_confirm.matches'] = 'Les mots de passe saisis ne correspondent pas.';
$lang['Clients.!error.passphrase_hint.length'] = 'La longueur de l\'indice de mot de passe ne doit pas dépasser 255 caractères.';
$lang['Clients.!error.passphrase_hint.secure'] = 'L\'indice de mot de passe peut ne pas correspondre au mot de passe lui-même.';
$lang['Clients.!error.passphrase.empty'] = 'Veuillez saisir une phrase de passe pour crypter cette note.';
$lang['Clients.!error.passphrase.length'] = 'La phrase de passe doit comporter au moins 8 caractères.';
