...
$lang['AdminClients.!error.bulk_inv_method.invalid_for_group'] = 'La méthode de facturation sélectionnée n\'est pas disponible pour les clients suivants en raison des paramètres de leur groupe de clients : %1$s';
...
$lang['AdminClients.!error.invalid_pricing_id'] = 'Le tarif sélectionné n\'est pas valide.';
...
$lang['AdminClients.!success.clients_autodebit_updated'] = 'Les clients sélectionnés ont été mis à jour.';
$lang['AdminClients.!success.clients_autosuspend_updated'] = 'Les clients sélectionnés ont été mis à jour.';
$lang['AdminClients.!success.clients_client_group_updated'] = 'Les clients sélectionnés ont été mis à jour.';
$lang['AdminClients.!success.clients_inv_method_updated'] = 'Les clients sélectionnés ont été mis à jour.';
$lang['AdminClients.!success.clients_payment_notices_updated'] = 'Les clients sélectionnés ont été mis à jour.';
$lang['AdminClients.!success.clients_status_updated'] = 'Les clients sélectionnés ont été mis à jour.';
...
$lang['AdminClients.!tooltip.note_private'] = 'Cette note n\'est visible que par le personnel.';
$lang['AdminClients.!tooltip.note_public'] = 'Cette mention figurera sur la facture et sera visible par le client.';
...
$lang['AdminClients.accounts.badge_auto_debit'] = 'Débit automatique';
$lang['AdminClients.accounts.badge_expired'] = 'Expiré';
$lang['AdminClients.accounts.badge_expiring'] = 'Expirant bientôt';
$lang['AdminClients.accounts.badge_unverified'] = 'Non vérifié';
$lang['AdminClients.accounts.boxtitle_accounts'] = 'Comptes de paiement';
$lang['AdminClients.accounts.categorylink_ach'] = 'Compte ACH';
$lang['AdminClients.accounts.categorylink_cc'] = 'Compte CC';
$lang['AdminClients.accounts.confirm_delete'] = 'Supprimer vraiment ce compte de paiement ?';
$lang['AdminClients.accounts.disclamer_default_gatway'] = '* Ce compte de paiement est stocké localement. La passerelle affichée est la passerelle par défaut pour la devise de ce client et peut être modifiée.';
...
$lang['AdminClients.accounts.text_expires'] = 'Expiration %1$s';
...
$lang['AdminClients.accounts.text_no_autodebit'] = 'Pas de débit automatique';
$lang['AdminClients.accounts.text_no_autodebit_desc'] = 'Ne pas débiter automatiquement un moyen de paiement';
...
$lang['AdminClients.add.field_cancel'] = 'Annuler';
...
$lang['AdminClients.addnote.field_encrypted'] = 'Chiffrer cette note';
$lang['AdminClients.addnote.field_notesubmit'] = 'Créer une note';
$lang['AdminClients.addnote.field_passphrase'] = 'Phrase secrète';
$lang['AdminClients.addnote.field_passphrase_confirm'] = 'Confirmer la phrase secrète';
$lang['AdminClients.addnote.field_passphrase_hint'] = 'Indice pour la phrase de passe (facultatif)';
...
$lang['AdminClients.addnote.text_encrypt_warning'] = 'Le corps de la note sera chiffré à l\'aide de cette phrase de passe. Celle-ci n\'est enregistrée nulle part et ne peut pas être récupérée : en cas de perte, le corps de la note deviendra définitivement illisible.';
$lang['AdminClients.addnote.text_hint_warning'] = 'L\'indice est stocké en clair et visible par toute personne pouvant consulter cette note. Ne saisissez pas la phrase de passe elle-même.';
...
$lang['AdminClients.addservice_basic.field_currency'] = 'Monnaie';
...
$lang['AdminClients.addservice_basic.no_module_options'] = 'Ce module n\'a pas d\'options configurables.';
...
$lang['AdminClients.addservice.field_package_no_results'] = 'Aucun paquet trouvé';
$lang['AdminClients.addservice.field_package_placeholder'] = 'Choisissez une formule';
$lang['AdminClients.addservice.field_package_search'] = 'Rechercher des forfaits';
...
$lang['AdminClients.contacts.categorylink_create'] = 'Ajouter un contact';
$lang['AdminClients.contacts.confirm_delete'] = 'Êtes-vous sûr de vouloir supprimer ce contact ?';
$lang['AdminClients.contacts.heading_email'] = 'Courriel';
$lang['AdminClients.contacts.heading_name'] = 'Nom';
$lang['AdminClients.contacts.heading_options'] = 'Actions';
$lang['AdminClients.contacts.heading_type'] = 'Type';
$lang['AdminClients.contacts.no_results'] = 'Il n\'y a pas de contacts pour ce client.';
$lang['AdminClients.contacts.option_delete'] = 'Supprimer';
$lang['AdminClients.contacts.option_edit'] = 'Editer';
$lang['AdminClients.contacts.page_title'] = 'Numéro de client%1$s Contacts';
...
$lang['AdminClients.createinvoice.field_invoicesubmit'] = 'Créer une facture';
...
$lang['AdminClients.createquotation.field_quotationsubmit'] = 'Créer un devis';
...
$lang['AdminClients.decryptnote.!error.passphrase'] = 'Le mot de passe saisi n\'est pas valide.';
...
$lang['AdminClients.delete.boxtitle_delete'] = 'Supprimer un client';
...
$lang['AdminClients.delete.heading_warning'] = 'Avertissement :';
$lang['AdminClients.delete.text_warning'] = 'Cette opération supprimera définitivement le client ainsi que tous les enregistrements associés (par exemple : contacts, services, factures, transactions, comptes de paiement, etc.). Cette action est irréversible.';
...
$lang['AdminClients.edit.field_cancel'] = 'Annuler';
$lang['AdminClients.edit.field_city'] = 'Ville';
$lang['AdminClients.edit.field_clientgroup'] = 'Groupe de clients';
$lang['AdminClients.edit.field_clientsubmit'] = 'Mise à jour du client';
...
$lang['AdminClients.editachaccount.field_accountsubmit'] = 'Mise à jour du compte';
...
$lang['AdminClients.editccaccount.field_accountsubmit'] = 'Mise à jour du compte';
...
$lang['AdminClients.editcontact.field_contactsubmit'] = 'Mise à jour du contact';
...
$lang['AdminClients.editinvoice.field_invoicesubmit'] = 'Mise à jour de la facture';
...
$lang['AdminClients.editinvoice.price_due'] = 'Date limite :';
$lang['AdminClients.editinvoice.price_paid'] = 'Rémunéré :';
...
$lang['AdminClients.editnote.field_current_passphrase'] = 'Phrase secrète';
$lang['AdminClients.editnote.field_description'] = 'Détails';
$lang['AdminClients.editnote.field_encrypted'] = 'Chiffrer cette note';
$lang['AdminClients.editnote.field_notesubmit'] = 'Note de mise à jour';
$lang['AdminClients.editnote.field_passphrase'] = 'Nouvelle phrase secrète (laisser ce champ vide pour conserver la phrase actuelle)';
$lang['AdminClients.editnote.field_passphrase_confirm'] = 'Confirmer la nouvelle phrase secrète';
$lang['AdminClients.editnote.field_passphrase_hint'] = 'Indice pour la phrase de passe (facultatif)';
$lang['AdminClients.editnote.field_stickied'] = 'Coller cette note';
$lang['AdminClients.editnote.field_title'] = 'Résumé';
$lang['AdminClients.editnote.field_unlock'] = 'Déverrouiller';
$lang['AdminClients.editnote.page_title'] = 'Client #%1$s Edit Note';
$lang['AdminClients.editnote.text_encrypt_warning'] = 'Le corps de la note sera chiffré à l\'aide de cette phrase de passe. Celle-ci n\'est enregistrée nulle part et ne peut pas être récupérée : en cas de perte, le corps de la note deviendra définitivement illisible.';
$lang['AdminClients.editnote.text_hint_warning'] = 'L\'indice est stocké en clair et visible par toute personne pouvant consulter cette note. Ne saisissez pas la phrase de passe elle-même.';
$lang['AdminClients.editnote.text_locked'] = 'Cette note est cryptée. Vous pouvez modifier le résumé et les paramètres de la note sans avoir à saisir la phrase de passe. Pour consulter ou modifier le corps de la note, déverrouillez-la à l\'aide de la phrase de passe.';
...
$lang['AdminClients.editservice.action_empty_state'] = 'Sélectionnez une action ci-dessus pour gérer ce service.';
...
$lang['AdminClients.editservice.confirm_cancel'] = 'Êtes-vous sûr de vouloir annuler ce service ? Cette action ne peut être annulée.';
$lang['AdminClients.editservice.field_add'] = 'Ajouter un champ';
$lang['AdminClients.editservice.field_add_addon'] = 'Ajouter un service';
$lang['AdminClients.editservice.field_cancel_service'] = 'Annuler le service';
...
$lang['AdminClients.editservice.field_override_currency'] = 'Monnaie';
...
$lang['AdminClients.editservice.modal_title_cancel'] = 'Confirmer l\'annulation';
...
$lang['AdminClients.editservice.tab_addon_label'] = 'Compléments';
...
$lang['AdminClients.edittransaction.field_submit'] = 'Mise à jour de la transaction';
...
$lang['AdminClients.index.action.change_autodebit'] = 'Débit automatique';
$lang['AdminClients.index.action.change_autosuspend'] = 'Suspension automobile';
$lang['AdminClients.index.action.change_client_group'] = 'Changer de groupe de clients';
$lang['AdminClients.index.action.change_inv_method'] = 'Méthode de facturation';
$lang['AdminClients.index.action.change_payment_notices'] = 'Avis de paiement';
$lang['AdminClients.index.action.change_status'] = 'Changement d\'état';
$lang['AdminClients.index.action.field_client_group'] = 'Groupe de clients';
$lang['AdminClients.index.action.field_inv_method'] = 'Méthode';
$lang['AdminClients.index.action.field_status'] = 'Statut';
$lang['AdminClients.index.action.field_toggle_disable'] = 'Désactiver';
$lang['AdminClients.index.action.field_toggle_enable'] = 'Activer';
...
$lang['AdminClients.index.field_actionsubmit'] = 'Soumettre';
...
$lang['AdminClients.index.items_selected'] = 'éléments sélectionnés';
...
$lang['AdminClients.invoices.field_invoicesubmit'] = 'Appliquer';
...
$lang['AdminClients.invoices.text_item_selected'] = 'élément sélectionné';
$lang['AdminClients.invoices.text_items_selected'] = 'éléments sélectionnés';
$lang['AdminClients.makepayment.badge_autodebit'] = 'Débit automatique';
$lang['AdminClients.makepayment.badge_expired'] = 'Expiré';
$lang['AdminClients.makepayment.badge_expiring'] = 'Expirant bientôt';
...
$lang['AdminClients.makepayment.card_info_cc'] = '%1$s %2$s - Expire à l\'adresse suivante : %3$s/%4$s';
...
$lang['AdminClients.makepayment.field_newmethod'] = 'Utiliser un nouveau mode de paiement';
...
$lang['AdminClients.makepayment.field_paymenttype'] = 'Type de paiement';
...
$lang['AdminClients.makepayment.heading_achinfo'] = 'Informations sur le compte bancaire';
$lang['AdminClients.makepayment.heading_ccinfo'] = 'Informations sur la carte de crédit';
$lang['AdminClients.makepayment.heading_contactinfo'] = 'Informations sur le contact';
...
$lang['AdminClients.makepayment.text_usefromaccount'] = 'Payer à l\'aide d\'un mode de paiement enregistré';
...
$lang['AdminClients.notes.field_decrypt'] = 'Décrypter';
$lang['AdminClients.notes.field_passphrase'] = 'Phrase secrète';
...
$lang['AdminClients.notes.text_encrypted'] = 'Crypté';
$lang['AdminClients.notes.text_encrypted_description'] = 'Cette note est cryptée. Saisissez la phrase de passe pour en consulter le contenu.';
$lang['AdminClients.notes.text_hint'] = 'Astuce : %1$s';
$lang['AdminClients.packages.boxtitle_packages'] = 'Paquets restreints';
$lang['AdminClients.packages.field_packagesubmit'] = 'Économiser';
...
$lang['AdminClients.pinnednotes.text_unpin'] = 'Note d\'épinglage';
...
$lang['AdminClients.quotations.field_quotationsubmit'] = 'Appliquer';
...
$lang['AdminClients.quotations.text_item_selected'] = 'élément sélectionné';
$lang['AdminClients.quotations.text_items_selected'] = 'éléments sélectionnés';
...
$lang['AdminClients.services.action.field_email'] = 'Courriel :';
...
$lang['AdminClients.services.field_actionsubmit'] = 'Appliquer';
...
$lang['AdminClients.services.heading_id'] = 'Numéro de service #';
...
$lang['AdminClients.services.page_title'] = 'Client n°%1$s Services';
$lang['AdminClients.services.recurring_term'] = '%1$s %2$s @ %3$s';
$lang['AdminClients.services.text_item_selected'] = 'élément sélectionné';
$lang['AdminClients.services.text_items_selected'] = 'éléments sélectionnés';
...
$lang['AdminClients.view.balance_title'] = 'Solde du compte';
...
$lang['AdminClients.view.delete_modal_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce client ? Cette action ne peut pas être annulée.';
...
$lang['AdminClients.view.pinned_notes_title'] = 'Notes épinglées';
$lang['AdminClients.view.quick_jump_empty'] = 'Pas de widgets disponibles';
$lang['AdminClients.view.quick_jump_title'] = 'Saut rapide';
