...
$lang['Clients.!error.encrypted.format'] = 'Værdien for »Encrypted« skal være enten 0 eller 1.';
...
$lang['Clients.!error.action[].exists'] = 'Ugyldig notifikationshandling.';
$lang['Clients.!error.action.exists'] = 'Ugyldig notifikationshandling "%1$s".';
$lang['Clients.!error.current_passphrase.valid'] = 'Den indtastede adgangskode er ugyldig.';
$lang['Clients.!error.passphrase_hint.secure'] = 'Hintet til adgangskoden må ikke være det samme som selve adgangskoden.';
$lang['Clients.!error.passphrase_hint.length'] = 'Længden på tipset til adgangskoden må ikke overstige 255 tegn.';
$lang['Clients.!error.passphrase_confirm.matches'] = 'De indtastede adgangskoder stemmer ikke overens.';
$lang['Clients.!error.passphrase.length'] = 'Adgangskoden skal bestå af mindst 8 tegn.';
$lang['Clients.!error.passphrase.empty'] = 'Indtast venligst en adgangskode for at kryptere denne note.';
