...
$lang['Transactions.!error.amount.applied'] = 'Transaktionsbeløbet må ikke være mindre end det beløb, der allerede er fratrukket på fakturaerne. Du skal først ophæve fradraget for transaktionen på en eller flere fakturaer.';
$lang['Transactions.!error.amount.format'] = 'Beløbet skal være et tal.';
$lang['Transactions.!error.amounts.applied'] = 'Værdierne for »Beløb, der skal betales« kunne ikke anvendes på de angivne fakturaer. Prøv venligst igen.';
