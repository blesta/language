...
$lang['AdminCompanyBilling.!error.postalmethods_return_address1.empty'] = 'Digite um endereço de retorno.';
$lang['AdminCompanyBilling.!error.postalmethods_return_city.empty'] = 'Digite uma cidade de endereço de retorno.';
$lang['AdminCompanyBilling.!error.postalmethods_return_company.empty'] = 'Digite um endereço de retorno da empresa.';
$lang['AdminCompanyBilling.!error.postalmethods_return_country.empty'] = 'Selecione um país para o endereço de retorno.';
$lang['AdminCompanyBilling.!error.postalmethods_return_name.empty'] = 'Digite um nome de endereço de retorno.';
$lang['AdminCompanyBilling.!error.postalmethods_return_state.empty'] = 'Selecione um endereço de retorno, estado/província.';
$lang['AdminCompanyBilling.!error.postalmethods_return_zip.empty'] = 'Digite o código postal do endereço de retorno.';
...
$lang['AdminCompanyBilling.!tooltip.quotation_format'] = 'As tags disponíveis incluem: {num} - o número da cotação (obrigatório); {year} - o ano com quatro dígitos; {month} - o mês com dois dígitos; {day} - o dia do mês com dois dígitos.';
$lang['AdminCompanyBilling.!tooltip.quotation_increment'] = 'Os números de cotação subsequentes serão incrementados por esse valor.';
$lang['AdminCompanyBilling.!tooltip.quotation_start'] = 'Os números de cotação começarão (e aumentarão) a partir desse valor inicial.';
...
$lang['AdminCompanyBilling.!tooltip.suspend_services_days_after_due'] = 'O número de dias que devem ser aguardados após o vencimento de uma fatura de serviço antes da suspensão do serviço. Se a opção “No mesmo dia” for selecionada, o serviço só será suspenso na data de vencimento da fatura se a tarefa de criação da fatura for executada antes da tarefa de suspensão do serviço na seção “Automação”.';
...
$lang['AdminCompanyBilling.addcoupon.heading_usage'] = 'Limitações de uso';
...
$lang['AdminCompanyBilling.deliverymethods.field_postalmethods_return_zip'] = 'CEP/Código Postal';
...
$lang['AdminCompanyBilling.deliverymethods.heading_postalmethods_return'] = 'Endereço de retorno';
...
$lang['AdminCompanyBilling.editcoupon.field_couponsubmit'] = 'Atualizar cupom';
...
$lang['AdminCompanyBilling.editcoupon.heading_terms'] = 'Limitações de prazo';
$lang['AdminCompanyBilling.editcoupon.heading_usage'] = 'Limitações de uso';
