...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Já foi gerada uma chave de API para sua assinatura do Blesta AI, e ela não pode ser recuperada. Revogue a chave existente na página “Gerenciar IA” do seu serviço em account.blesta.com e tente novamente.';
...
$lang['AdminSystemAi.index.degraded_model'] = 'O modelo selecionado no momento, “%1$s ”, não está mais disponível. Os recursos de IA estão utilizando temporariamente o modelo “%2$s ”. Escolha um novo modelo padrão abaixo e salve.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s créditos por 1 mil tokens)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Seu nome de usuário no account.blesta.com e sua chave de licença do Blesta serão usados para validar sua licença e obter automaticamente uma nova chave da API de IA do Blesta. Se já tiver sido gerada uma chave, ela deverá primeiro ser revogada na página “Gerenciar IA” do seu serviço em account.blesta.com antes que uma nova chave possa ser emitida.';
