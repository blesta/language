...
$lang['Transactions.!error.amount.applied'] = 'O valor da transação não pode ser inferior ao valor já aplicado às faturas. Primeiro, cancele a aplicação da transação em uma ou mais faturas.';
$lang['Transactions.!error.amount.format'] = 'O valor deve ser um número.';
$lang['Transactions.!error.amounts.applied'] = 'Os valores de “Valor a pagar” não puderam ser aplicados às faturas especificadas. Tente novamente.';
