...
$lang['PackageOptions.getfields.label_checkbox_setup_recurring'] = '%1$s (%2$s + %3$s kurulum, yenileme @ %4$s)';
...
$lang['PackageOptions.getfields.label_radio_setup_recurring'] = '%1$s (%2$s + %3$s kurulum, yenileme @ %4$s)';
...
$lang['PackageOptions.getfields.label_select_setup_recurring'] = '%1$s (%2$s + %3$s kurulum, yenileme @ %4$s)';
