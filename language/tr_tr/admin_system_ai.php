...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Blesta AI aboneliğiniz için bir API anahtarı zaten oluşturulmuştur ve bu anahtar tekrar alınamaz. Lütfen account.blesta.com adresindeki hizmetinizin “AI’yı Yönet” sayfasından mevcut anahtarı iptal edin, ardından lütfen tekrar deneyin.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s 1.000 token başına kredi)';
...
$lang['AdminSystemAi.modal.text_info'] = 'account.blesta.com adresindeki kullanıcı adınız ve Blesta lisans anahtarınız, lisansınızı doğrulamak ve yeni bir Blesta AI API anahtarını otomatik olarak almak için kullanılacaktır. Daha önce bir anahtar oluşturulmuşsa, yeni bir anahtarın verilebilmesi için öncelikle account.blesta.com adresindeki hizmetinize ait “AI’yı Yönet” sayfasından bu anahtarın iptal edilmesi gerekir.';
