...
$lang['Cron.autodebitinvoices.charge_attempt'] = '%1$s numaralı müşterinin hesabından, toplam tutarı %2$s olan tüm açık faturalar için otomatik ödeme işlemi gerçekleştirilmeye çalışılıyor.';
...
$lang['Cron.suspendservices.suspend_success'] = '%2$s adresindeki istemciden gelen #%1$s numaralı hizmet askıya alınmıştır.';
