...
$lang['Invoices.!error.invoice_id.unique'] = 'Hedef fatura, birleştirilecek faturaların bir parçası olamaz.';
$lang['Invoices.!error.invoice_ids.client'] = 'Tüm faturalar aynı müşteriye ait olmalıdır.';
...
$lang['Invoices.!error.invoice_ids.status'] = 'Tüm faturalar açık ve herhangi bir işlem yapılmamış olmalıdır.';
...
$lang['Invoices.!line_item.service_option_prorated_upgrade_qty_date'] = '↳ %1$s adresindeki aboneliğin, %2$sx %3$s adresinden %4$sx %5$s adresine orantılı olarak yükseltilmesi (%6$s - %7$s)';
