...
$lang['AdminSystemAi.modal.text_info'] = 'Ваше имя пользователя account.blesta.com и лицензионный ключ Blesta будут использованы для проверки лицензии и автоматического получения нового ключа Blesta AI API. Если ключ уже был сгенерирован, он будет аннулирован и выдан новый.';
