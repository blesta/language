...
$lang['ClientGroups.!error.clients_format.format'] = 'Формат идентификатора клиента должен содержать {num}.';
$lang['ClientGroups.!error.group_id.exists'] = 'Неверный идентификатор группы клиентов.';
