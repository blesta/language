...
$lang['ServiceInvoices.!error.date_next_attempt.format'] = 'Дата следующей попытки должна быть датой.';
$lang['ServiceInvoices.!error.maximum_attempts.format'] = 'Максимальное количество попыток должно быть числом.';
