...
$lang['Transactions.!error.amount.applied'] = 'Сумма транзакции не может быть меньше суммы, уже зачтенной в счетах-фактурах. Сначала необходимо отменить зачет транзакции в одном или нескольких счетах-фактурах.';
$lang['Transactions.!error.amount.format'] = 'Сумма должна быть числом.';
$lang['Transactions.!error.amounts.applied'] = 'Значения «Сумма к оплате» не удалось применить к указанным счетам. Пожалуйста, повторите попытку.';
