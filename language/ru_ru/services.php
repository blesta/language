...
$lang['Services.getActions.uncancel'] = 'Активировать';
$lang['Services.!error.uncancel.unsupported'] = 'Эта услуга не может быть отменена, так как модуль ее не поддерживает.';
