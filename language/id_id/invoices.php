...
$lang['Invoices.!line_item.service_option_prorated_upgrade'] = '↳ Peningkatan versi " %1$s " secara proporsional dari " %2$s " ke %3$s';
$lang['Invoices.!line_item.service_option_prorated_upgrade_date'] = '↳ Peningkatan berproporsional untuk paket " %1$s " dari " %2$s " menjadi " %3$s " (%4$s - %5$s)';
$lang['Invoices.!line_item.service_option_prorated_upgrade_onetime'] = '↳ Peningkatan berproporsional untuk " %1$s " dari " %2$s " ke %3$s';
...
$lang['Invoices.!line_item.service_prorated_upgrade_description'] = 'Peningkatan Berbasis Proporsional dari %1$s ke %2$s - %3$s (%4$s - %5$s)';
$lang['Invoices.!line_item.service_prorated_upgrade_description_onetime'] = 'Peningkatan Berbasis Proporsional dari %1$s ke %2$s - %3$s';
...
$lang['Invoices.!note_private.service_cancel_date'] = 'Layanan #%1$s dibatalkan %2$s.';
