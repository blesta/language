...
$lang['Transactions.!error.amount.applied'] = 'Částka transakce nesmí být nižší než částka, která již byla přiřazena k fakturám. Nejprve zrušte přiřazení této transakce k jedné nebo více fakturám.';
$lang['Transactions.!error.amount.format'] = 'Částka musí být číslo.';
$lang['Transactions.!error.amounts.applied'] = 'Hodnoty „Částka k zaplacení“ nebylo možné použít na uvedené faktury. Zkuste to prosím znovu.';
