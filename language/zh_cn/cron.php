...
$lang['Cron.autodebitinvoices.charge_attempt'] = '试图自动从客户 #%1$s 的所有未结账单中扣除 %2$s。';
$lang['Cron.autodebitinvoices.completed'] = '自动借记账单任务已完成。';
$lang['Cron.autodebitinvoices.attempt'] = '试图从未结账单上自动扣款。';
$lang['Cron.applycredits.apply_none'] = '没有任何账单可用于贷记。';
$lang['Cron.applycredits.apply_success'] = '成功地将客户 #%2$s 的交易 %1$s 中的待处理贷项应用到账单 #%3$s 中，金额为 %4$s。';
$lang['Cron.applycredits.apply_failed'] = '无法为客户 #%1$s 申请待定积分。';
$lang['Cron.applycredits.completed'] = '积分申请任务已完成。';
$lang['Cron.applycredits.attempt'] = '试图将贷项用于未结账单。';
