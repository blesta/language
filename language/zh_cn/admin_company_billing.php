...
$lang['AdminCompanyBilling.!tooltip.inv_terms'] = '输入付款条件或您希望在账单上显示的任何其他信息。';
$lang['AdminCompanyBilling.customization.field.inv_proforma_format'] = '形式账单格式';
$lang['AdminCompanyBilling.!tooltip.inv_font'] = '如需其他字体，请将自定义 TCPDF 字体解压缩到安装目录下的 /vendors/tecnickcom/tcpdf/fonts/ 目录中。';
$lang['AdminCompanyBilling.customization.field.inv_draft_format'] = '账单草稿格式';
$lang['AdminCompanyBilling.!tooltip.inv_mimetype'] = '账单文件类型。账单模板可能支持各种文件类型。';
$lang['AdminCompanyBilling.customization.field.inv_format'] = '账单格式';
$lang['AdminCompanyBilling.!tooltip.inv_template'] = '用于渲染账单的账单模板。';
$lang['AdminCompanyBilling.customization.heading_lookandfeel'] = '外观和感觉';
$lang['AdminCompanyBilling.!tooltip.inv_paper_size'] = '账单纸张大小。';
$lang['AdminCompanyBilling.customization.heading_cache'] = '缓存';
$lang['AdminCompanyBilling.!tooltip.inv_background'] = '上传将出现在账单上的背景。';
$lang['AdminCompanyBilling.customization.heading_quotations'] = '报价选项';
$lang['AdminCompanyBilling.!tooltip.inv_logo'] = '上传要出现在账单上的徽标。';
...
$lang['AdminCompanyBilling.customization.boxtitle_customization'] = '账单定制';
$lang['AdminCompanyBilling.!tooltip.inv_cache'] = '在磁盘上保存每张账单的缓存副本。';
$lang['AdminCompanyBilling.customization.page_title'] = '设置 > 公司 > 账单/付款 > 账单定制';
$lang['AdminCompanyBilling.!tooltip.inv_pad_str'] = '字符长度小于账单填充大小的账单号码将向左填充给定的字符。';
$lang['AdminCompanyBilling.editcoupon.text_used_qty'] = '(已使用 %1$s）';
$lang['AdminCompanyBilling.!tooltip.inv_pad_size'] = '账单填充大小设置账单号码的最小字符长度。';
$lang['AdminCompanyBilling.editcoupon.text_available_packages'] = '可用套餐';
$lang['AdminCompanyBilling.!tooltip.inv_increment'] = '以后的账单号码将按此值递增。';
$lang['AdminCompanyBilling.editcoupon.text_assigned_packages'] = '指定包件';
$lang['AdminCompanyBilling.!tooltip.inv_proforma_start'] = '账单号码将从该起始值开始（并递增）。';
$lang['AdminCompanyBilling.editcoupon.text_all'] = '全部';
$lang['AdminCompanyBilling.!tooltip.inv_start'] = '账单号码将从该起始值开始（并递增）。';
$lang['AdminCompanyBilling.editcoupon.field_couponsubmit'] = '编辑优惠券';
$lang['AdminCompanyBilling.!tooltip.inv_proforma_format'] = '可用标记包括{num}--账单号码（必填）； {year} --四位数字的年； {month} --两位数字的月； {day} --两位数字的月日。';
$lang['AdminCompanyBilling.editcoupon.field_package_group_id'] = '套餐组过滤器';
$lang['AdminCompanyBilling.!tooltip.inv_draft_format'] = '可用标记包括{num}--账单号码（必填）； {year} --四位数字的年； {month} --两位数字的月； {day} --两位数字的月日。';
$lang['AdminCompanyBilling.editcoupon.heading_packages'] = '套餐';
$lang['AdminCompanyBilling.!tooltip.inv_format'] = '可用标记包括{num}--账单号码（必填）； {year} --四位数字的年； {month} --两位数字的月； {day} --两位数字的月日。';
$lang['AdminCompanyBilling.editcoupon.option_remove'] = '移除';
$lang['AdminCompanyBilling.!tooltip.inv_type'] = '默认创建的账单类型。形式账单在付款和关闭后会更改为标准账单。';
...
$lang['AdminCompanyBilling.!tooltip.third_notice'] = '在账单到期之前或之后发送第三封逾期通知电子邮件的天数。';
$lang['AdminCompanyBilling.editcoupon.text_period'] = '期间';
$lang['AdminCompanyBilling.!tooltip.second_notice'] = '在账单到期之前或之后发送第二封逾期通知电子邮件的天数。';
$lang['AdminCompanyBilling.editcoupon.text_enabled'] = '已启用';
$lang['AdminCompanyBilling.!tooltip.first_notice'] = '在账单到期之前或之后发送第一封逾期通知电子邮件的天数。';
...
$lang['AdminCompanyBilling.editcoupon.text_value'] = '值';
...
$lang['AdminCompanyBilling.!tooltip.late_fee_total_amount'] = '如果费用类型是百分比，则选中此项可根据账单总额计算费用。如果不勾选此项，则只根据未付金额计算费用。';
...
$lang['AdminCompanyBilling.!tooltip.void_inv_canceled_service_days'] = '如果与已取消服务相关的账单已逾期，则只有在逾期天数未超过所选天数时才会作废。';
$lang['AdminCompanyBilling.editcoupon.heading_discount'] = '折扣选项';
$lang['AdminCompanyBilling.!tooltip.void_invoice_canceled_service'] = '选中后，服务取消也会使与取消服务相关的任何未结账单作废。如果账单中包含与服务无关的细列项目，服务细列项目将被删除，账单不会作废。';
$lang['AdminCompanyBilling.editcoupon.field_limit_recurring_yes'] = '续订服务有限制';
$lang['AdminCompanyBilling.!tooltip.auto_paid_pending_services'] = '勾选是否允许 Blesta 自动提供待处理且账单已支付的服务。';
$lang['AdminCompanyBilling.editcoupon.field_limit_recurring_no'] = '限制不适用于续订服务';
$lang['AdminCompanyBilling.!tooltip.auto_apply_credits'] = '选中允许 Blesta 自动将贷项应用于未结账单（最旧账单优先）。';
...
$lang['AdminCompanyBilling.!tooltip.inv_lines_verbose_option_dates'] = '选中以包括每个可配置选项账单项目的服务日期范围。';
$lang['AdminCompanyBilling.editcoupon.field_recurring_yes'] = '服务添加或更新时应用';
$lang['AdminCompanyBilling.!tooltip.inv_append_descriptions'] = '选中可将文字版 "套餐说明 "附加到服务细列项目。';
$lang['AdminCompanyBilling.editcoupon.field_recurring_no'] = '仅在添加服务时适用';
$lang['AdminCompanyBilling.!tooltip.inv_group_services'] = '为客户同一天续订的服务创建一张账单。取消选中将为每项服务创建一张单独的账单。';
$lang['AdminCompanyBilling.editcoupon.heading_basic'] = '基本';
$lang['AdminCompanyBilling.!tooltip.inv_suspended_services'] = '选中以继续开具暂停服务的账单。';
$lang['AdminCompanyBilling.editcoupon.boxtitle_edit'] = '编辑优惠券';
$lang['AdminCompanyBilling.!tooltip.client_set_invoice'] = '勾选允许客户选择他们喜欢的账单交付方式（如纸质或电子邮件）。';
...
$lang['AdminCompanyBilling.!tooltip.apply_inv_late_fees'] = '对到期后配置天数的未结账单收取滞纳金。';
$lang['AdminCompanyBilling.addcoupon.text_all'] = '全部';
$lang['AdminCompanyBilling.!tooltip.cancel_service_changes_days'] = '当账单在选定天数内未支付时，排队的服务变更将自动取消。';
...
$lang['AdminCompanyBilling.addcoupon.field_package_group_id'] = '套餐组过滤器';
...
$lang['AdminCompanyBilling.!tooltip.suspend_services_days_after_due'] = '服务账单逾期后暂停服务的等待天数。';
$lang['AdminCompanyBilling.addcoupon.option_remove'] = '移除';
$lang['AdminCompanyBilling.!tooltip.autodebit_days_before_due'] = '自动从客户默认付款账户扣款的账单到期前天数（如果客户已配置为自动扣款）。';
...
$lang['AdminCompanyBilling.!tooltip.inv_days_before_renewal'] = '服务或定期账单续订前生成账单的天数。';
...
$lang['AdminCompanyBilling.addcoupon.text_value'] = '值';
$lang['AdminCompanyBilling.!error.extension_zlib'] = '账单压缩需要 Zlib 扩展。';
...
$lang['AdminCompanyBilling.!error.inv_increment.valid'] = '账单增量值必须是一个数字。';
$lang['AdminCompanyBilling.addcoupon.field_limit_recurring_no'] = '限制不适用于续订服务';
$lang['AdminCompanyBilling.!error.inv_start.valid'] = '账单起始值必须是数字。';
$lang['AdminCompanyBilling.addcoupon.field_max_qty'] = '数量';
$lang['AdminCompanyBilling.!success.customization_updated'] = '账单自定义设置已成功更新！';
...
$lang['AdminCompanyBilling.!success.deliverymethods_updated'] = '账单交付设置已成功更新！';
...
$lang['AdminCompanyBilling.!success.invoices_updated'] = '账单和收费设置已成功更新！';
...
$lang['AdminCompanyBilling.coupons.text_used'] = '已使用';
$lang['AdminCompanyBilling.latefees.field.percent'] = '百分比';
$lang['AdminCompanyBilling.coupons.text_discount'] = '折扣';
$lang['AdminCompanyBilling.latefees.field.late_fee_total_amount'] = '适用于账单总金额';
...
$lang['AdminCompanyBilling.deliverymethods.note_colored'] = '请注意，如果选中该选项，发送到 PostalMethods 的所有账单都将是彩色的，而不是黑白的。';
$lang['AdminCompanyBilling.notices.field.second_notice'] = '第二次通知';
$lang['AdminCompanyBilling.deliverymethods.note_doublesided'] = '如果选中此选项，发送到 PostalMethods 的账单将在页面正反面使用打印。';
...
$lang['AdminCompanyBilling.notices.text_disabled'] = '禁用';
...
$lang['AdminCompanyBilling.deliverymethods.field_delivery_methods'] = '账单交付方式';
$lang['AdminCompanyBilling.notices.text_day'] = '%1$s 日';
$lang['AdminCompanyBilling.deliverymethods.postalmethods_desc'] = 'PostalMethods 为您打印、装箱并向客户邮寄账单。<a href="https://cp.postalmethods.com/public/agentredirect.aspx?agentid=5bcfe2fb-b897-4a26-8c91-4089e92e2a7d" target="_blank">注册</a>PostalMethods 账户，立即开始邮寄账单。';
$lang['AdminCompanyBilling.notices.text_inv_duedate'] = '账单到期日';
$lang['AdminCompanyBilling.deliverymethods.heading_postalmethods'] = '邮寄方式';
$lang['AdminCompanyBilling.notices.text_after'] = '之后';
$lang['AdminCompanyBilling.deliverymethods.interfax_desc'] = 'InterFax 允许您通过互联网传真账单。<a href="http://www.interfax.net/" target="_blank">注册</a> InterFax 账户，立即开始传真账单。';
...
$lang['AdminCompanyBilling.deliverymethods.boxtitle_deliverymethods'] = '账单交付';
$lang['AdminCompanyBilling.notices.page_title'] = '设置 > 公司 > 账单/付款 > 通知';
$lang['AdminCompanyBilling.deliverymethods.page_title'] = '设置 > 公司 > 账单/付款 > 账单交付';
$lang['AdminCompanyBilling.invoices.field.quotation_deposit_percentage'] = '报价 默认存款百分比 (%)';
$lang['AdminCompanyBilling.customization.field.inv_proforma_start'] = '形式账单起始值';
...
$lang['AdminCompanyBilling.customization.field.inv_start'] = '账单起始值';
...
$lang['AdminCompanyBilling.invoices.field.void_inv_canceled_service_days'] = '到期后几天未结账单作废';
$lang['AdminCompanyBilling.acceptedtypes.page_title'] = '设置 > 公司 > 账单/付款 > 接受的付款类型';
$lang['AdminCompanyBilling.invoices.field.void_invoice_canceled_service'] = '取消服务时未结账单作废';
...
$lang['AdminCompanyBilling.customization.field.inv_mimetype'] = '账单文件类型';
...
$lang['AdminCompanyBilling.invoices.field.inv_append_descriptions'] = '在账单上包含套餐说明';
$lang['AdminCompanyBilling.customization.field.inv_display'] = '在账单上显示';
$lang['AdminCompanyBilling.invoices.field.inv_group_services'] = '共同开具服务账单';
$lang['AdminCompanyBilling.customization.field.inv_template'] = '账单模板';
$lang['AdminCompanyBilling.invoices.field.inv_suspended_services'] = '暂停服务账单';
$lang['AdminCompanyBilling.customization.field.inv_paper_size'] = '纸张大小';
$lang['AdminCompanyBilling.invoices.field.client_set_invoice'] = '允许客户设置账单方式';
...
$lang['AdminCompanyBilling.invoices.field.apply_inv_late_fees'] = '对到期后的未结账单收取滞纳金';
...
$lang['AdminCompanyBilling.customization.field.inv_cache_compress'] = '压缩 PDF 账单';
$lang['AdminCompanyBilling.invoices.field.service_renewal_attempts'] = '服务续订尝试';
$lang['AdminCompanyBilling.customization.field.inv_cache'] = '账单缓存方法';
...
$lang['AdminCompanyBilling.invoices.field.inv_days_before_renewal'] = '续订前账单天数';
$lang['AdminCompanyBilling.customization.field.inv_type'] = '账单类型';
$lang['AdminCompanyBilling.invoices.boxtitle_invoices'] = '账单和收费选项';
$lang['AdminCompanyBilling.customization.field.inv_pad_str'] = '账单填充字符';
$lang['AdminCompanyBilling.invoices.page_title'] = '设置 > 公司 > 账单/付款 > 账单和收费选项';
$lang['AdminCompanyBilling.customization.field.inv_pad_size'] = '账单填充尺寸';
$lang['AdminCompanyBilling.!notice.group_settings'] = '注意：这些设置只适用于从公司继承其设置的客户组。';
$lang['AdminCompanyBilling.customization.field.inv_increment'] = '账单增量值';
