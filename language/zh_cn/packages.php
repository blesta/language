...
$lang['Packages.getPricingPeriods.month_plural'] = '每月';
$lang['Packages.getPricingPeriods.week_plural'] = '每周';
$lang['Packages.getPricingPeriods.day_plural'] = '每天天';
$lang['Packages.getPricingPeriods.onetime'] = '一次性付款';
$lang['Packages.getPricingPeriods.year'] = '每年';
$lang['Packages.getPricingPeriods.month'] = '每月';
$lang['Packages.getPricingPeriods.week'] = '每周';
$lang['Packages.getPricingPeriods.day'] = '每天';
$lang['Packages.!error.groups[].valid'] = '所选套餐分组不属于给定的公司。';
$lang['Packages.!error.groups[].exists'] = '套餐分组 ID 无效。';
...
$lang['Packages.!error.option_groups[].valid'] = '给出的可配置套餐选项组无效。';
$lang['Packages.!error.client_qty.format'] = '客户限制必须是一个数字。';
$lang['Packages.!error.qty.format'] = '数量必须是一个数字。';
$lang['Packages.!error.descriptions.empty_lang'] = '请为每个说明指定一个套餐语言代码。';
$lang['Packages.!error.descriptions.format'] = '套餐描述格式无效。';
$lang['Packages.!error.names.empty_lang'] = '请为每个名称指定一个套餐语言代码。';
$lang['Packages.!error.names.empty_name'] = '请为每种语言指定一个套餐名称。';
$lang['Packages.!error.names.format'] = '套餐名称格式无效。';
$lang['Packages.!error.module_id.changed'] = '不能更改模块，因为已有一个或多个服务在使用此套餐。';
$lang['Packages.!error.module_id.exists'] = '给出的模块无效。';
$lang['Packages.!error.package_id.has_children'] = '由于服务有子服务，因此无法删除套餐。';
$lang['Packages.!error.package_id.exists'] = '无法删除套餐，因为有服务正在使用该套餐。';
