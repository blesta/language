...
$lang['Invoices.!error.line_items.minimum_split'] = '账单必须至少有两行才能分割。';
$lang['Invoices.!error.line_items.empty_split'] = '未选择要分割的账单行。';
...
$lang['Invoices.!error.invoice_id.draft'] = '给定账单不是草稿账单，因此无法删除。';
$lang['Invoices.!error.date_last_renewed.format'] = '最后一次周期性账单更新日期必须是有效的日期格式。';
$lang['Invoices.!error.date_renews.format'] = '经常性账单更新日期必须是有效的日期格式。';
...
$lang['Invoices.!error.autodebit.valid'] = '请选择是否允许此账单自动转账。';
...
$lang['Invoices.!error.id.amount_applied'] = '账单行、币种和状态可能不会更新，因为该账单已应用了一个金额。';
$lang['Invoices.!error.id_value.valid'] = '无法确定账单 ID 值。';
$lang['Invoices.!error.id_format.length'] = '账单 ID 格式不得超过 64 个字符。';
$lang['Invoices.!error.id_format.empty'] = '未为账单设置 ID 格式。';
$lang['Invoices.!error.invoice_add.failed'] = '无法创建该账单。请重试。';
$lang['Invoices.!error.delivery.length'] = '账单交付方式长度不得超过 32 个字符。';
$lang['Invoices.!error.delivery.empty'] = '请输入账单交付方式。';
$lang['Invoices.!error.method.exists'] = '您必须设置至少一种交付方式。';
$lang['Invoices.!error.invoice_recur_id.exists'] = '经常性账单 ID 无效。';
$lang['Invoices.!error.invoice_id.exists'] = '账单 ID 无效。';
...
$lang['Invoices.status.active'] = '已激活';
