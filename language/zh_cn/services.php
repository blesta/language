...
$lang['Services.getStatusTypes.active'] = '已激活';
...
$lang['Services.!error.invoice_method.valid'] = '您必须选择有效的账单方式。';
...
$lang['Services.!error.client_id.allowed'] = '客户端无法访问该套餐。';
...
$lang['Services.!error.id_value.valid'] = '无法确定账单 ID 值。';
$lang['Services.!error.id_format.length'] = '账单 ID 格式不得超过 64 个字符。';
$lang['Services.!error.id_format.empty'] = '未为账单设置 ID 格式。';
$lang['Services.!error.package_group_id.exists'] = '套餐分组 ID 无效。';
...
$lang['Services.!error.move.unpaid_invoices'] = '该服务无法转移给其他客户，因为它有未支付的账单。';
