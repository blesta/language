...
$lang['ClientPay.received.invoices'] = '账单 #';
...
$lang['ClientPay.confirm.description_invoice'] = '账单 #%1$s';
...
$lang['ClientPay.multipleinvoices.no_results'] = '没有该货币的账单。';
$lang['ClientPay.multipleinvoices.text_datedue'] = '到期日期';
$lang['ClientPay.multipleinvoices.text_invoice'] = '账单 #';
...
$lang['ClientPay.method.heading_invoice'] = '账单 #%1$s';
...
$lang['ClientPay.!error.invoice_voided'] = '该账单已作废，无法支付。';
$lang['ClientPay.!error.payment_amounts'] = '请选择要支付的账单或输入其他付款金额。';
...
$lang['ClientPay.!success.invoice_paid'] = '该账单之前已经支付。';
