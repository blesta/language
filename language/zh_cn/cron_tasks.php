...
$lang['CronTasks.crontask.description.deliver_reports'] = 'A/R、账单生成、纳税义务和其他报告将在每天指定的时间发送。';
...
$lang['CronTasks.crontask.description.deliver_invoices'] = '计划交付的账单将按所选时间间隔发送。';
$lang['CronTasks.crontask.name.deliver_invoices'] = '交付账单';
...
$lang['CronTasks.crontask.description.apply_payments'] = '松动贷记会按所选时间间隔自动应用于未结账单。';
$lang['CronTasks.crontask.name.apply_payments'] = '将付款应用于未结账单';
...
$lang['CronTasks.crontask.description.autodebit'] = '选择自动扣款的付款账户将在每天指定的时间运行，以支付未结账单。';
$lang['CronTasks.crontask.name.autodebit'] = '自动借记';
$lang['CronTasks.crontask.description.apply_invoice_late_fees'] = '对到期后配置天数的未结账单收取滞纳金。';
$lang['CronTasks.crontask.name.apply_invoice_late_fees'] = '申请账单滞纳金';
$lang['CronTasks.crontask.description.create_invoice'] = '周期性账单和续订服务通过该任务开具账单，该任务每天在指定时间运行一次。';
$lang['CronTasks.crontask.name.create_invoice'] = '创建账单';
