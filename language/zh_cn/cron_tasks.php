...
$lang['CronTasks.!error.task_id.unique'] = '该公司已经安排运行该cron任务了。';
...
$lang['CronTasks.crontask.description.analytics_snapshots'] = '记录“报告”收入智能仪表盘所使用的每日MRR、流量和收入汇总数据。';
...
$lang['CronTasks.crontask.name.analytics_snapshots'] = '收入情报快照';
