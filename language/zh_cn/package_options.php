...
$lang['PackageOptions.getvaluestatuses.inactive'] = '禁用';
$lang['PackageOptions.getvaluestatuses.active'] = '已激活';
$lang['PackageOptions.gettypes.password'] = '密码';
$lang['PackageOptions.gettypes.textarea'] = '文本区域';
$lang['PackageOptions.gettypes.text'] = '文本';
$lang['PackageOptions.gettypes.radio'] = '单选框';
...
$lang['PackageOptions.!error.values[][pricing][][id].delete_in_use'] = '不得删除期权值定价，因为它目前正由某项服务使用。';
$lang['PackageOptions.!error.values[][pricing][][id].exists'] = '套餐选项定价 ID 无效。';
$lang['PackageOptions.!error.hidden.valid'] = '是否隐藏该选项必须设置为 0 或 1。';
$lang['PackageOptions.!error.option_id.exists'] = '套餐选项 ID 无效。';
$lang['PackageOptions.!error.groups.exists'] = '给出的套餐选项组 ID 中至少有一个不存在或不属于同一公司。';
$lang['PackageOptions.!error.values[][id].exists'] = '套餐选项值 ID 无效。';
