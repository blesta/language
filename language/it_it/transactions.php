...
$lang['Transactions.!error.amount.applied'] = 'L\'importo della transazione non può essere inferiore all\'importo già applicato alle fatture. Annulla prima l\'applicazione della transazione a una o più fatture.';
$lang['Transactions.!error.amount.format'] = 'L\'importo deve essere un numero.';
$lang['Transactions.!error.amounts.applied'] = 'Non è stato possibile applicare gli importi da pagare alle fatture specificate. Riprovare.';
