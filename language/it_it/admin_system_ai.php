...
$lang['AdminSystemAi.!error.key_already_exists'] = 'È già stata generata una chiave API per il tuo abbonamento a Blesta AI e non è possibile recuperarla nuovamente. Ti preghiamo di revocare la chiave esistente dalla pagina "Gestisci AI" del tuo servizio all\'indirizzo account.blesta.com, quindi riprova.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s crediti ogni 1.000 token)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Il nome utente del tuo account su account.blesta.com e la tua chiave di licenza Blesta verranno utilizzati per convalidare la licenza e ottenere automaticamente una nuova chiave API Blesta AI. Se è già stata generata una chiave, questa dovrà prima essere revocata dalla pagina “Gestisci AI” relativa al tuo servizio su account.blesta.com prima che possa essere emessa una nuova chiave.';
