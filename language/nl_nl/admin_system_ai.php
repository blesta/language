...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Er is al een API-sleutel gegenereerd voor uw Blesta AI-abonnement en deze kan niet opnieuw worden opgevraagd. Trek de bestaande sleutel in via de pagina ‘AI beheren’ voor uw dienst op account.blesta.com en probeer het vervolgens opnieuw.';
...
$lang['AdminSystemAi.index.degraded_model'] = 'Het momenteel geselecteerde model "%1$s" is niet langer beschikbaar. De AI-functies maken tijdelijk gebruik van "%2$s". Kies hieronder een nieuw standaardmodel en sla je keuze op.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s credits per 1K tokens)';
$lang['AdminSystemAi.index.model_recommended'] = '(Aanbevolen)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Uw gebruikersnaam op account.blesta.com en uw Blesta-licentiesleutel worden gebruikt om uw licentie te valideren en automatisch een nieuwe Blesta AI-API-sleutel op te halen. Als er al een sleutel is gegenereerd, moet deze eerst worden ingetrokken via de pagina ‘AI beheren’ voor uw dienst op account.blesta.com, voordat er een nieuwe sleutel kan worden aangemaakt.';
