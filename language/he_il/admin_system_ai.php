...
$lang['AdminSystemAi.!error.key_already_exists'] = 'מפתח API כבר נוצר עבור המנוי שלך ל-Blesta AI, ולא ניתן לשחזר אותו. אנא בטל את המפתח הקיים מדף \'ניהול AI\' של השירות שלך בכתובת account.blesta.com, ולאחר מכן נסה שוב.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s נקודות זכות לכל 1,000 אסימונים)';
...
$lang['AdminSystemAi.modal.text_info'] = 'שם המשתמש שלך ב-account.blesta.com ומפתח הרישיון שלך ל-Blesta ישמשו לאימות הרישיון שלך ולהפקת מפתח API חדש של Blesta AI באופן אוטומטי. אם כבר נוצר מפתח, יש לבטלו תחילה מדף "ניהול AI" של השירות שלך ב-account.blesta.com לפני שניתן יהיה להנפיק מפתח חדש.';
