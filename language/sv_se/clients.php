...
$lang['Clients.!error.current_passphrase.valid'] = 'Den angivna lösenfrasen är ogiltig.';
...
$lang['Clients.!error.encrypted.format'] = 'Värdet för ”Encrypted” måste vara 0 eller 1.';
...
$lang['Clients.!error.passphrase_confirm.matches'] = 'De angivna lösenfraserna stämmer inte överens.';
$lang['Clients.!error.passphrase_hint.length'] = 'Längden på ledtråden till lösenordsfrasen får inte överstiga 255 tecken.';
$lang['Clients.!error.passphrase_hint.secure'] = 'Ledtråden till lösenfrasen behöver inte vara densamma som lösenfrasen.';
$lang['Clients.!error.passphrase.empty'] = 'Ange en lösenfras för att kryptera denna anteckning.';
$lang['Clients.!error.passphrase.length'] = 'Lösenordsfrasen måste bestå av minst 8 tecken.';
