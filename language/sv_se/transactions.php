...
$lang['Transactions.!error.amount.applied'] = 'Transaktionsbeloppet får inte vara lägre än det belopp som redan har avdragsförts från fakturor. Avdrah först transaktionen från en eller flera fakturor.';
$lang['Transactions.!error.amount.format'] = 'Beloppet måste vara ett tal.';
$lang['Transactions.!error.amounts.applied'] = 'Beloppen kunde inte tillämpas på de angivna fakturorna. Försök igen.';
