...
$lang['AdminLogin.!info.otp'] = 'Tvåfaktorsautentisering krävs för den här användaren. Ange ditt OTP (engångslösenord) nedan.';
$lang['AdminLogin.!info.reset_password'] = 'Ange ditt användarnamn nedan så får du en tidskänslig länk skickad till dig så att du kan ange ett nytt lösenord.';
$lang['AdminLogin.!success.reset_sent'] = 'Ett bekräftelsemeddelande har skickats till den registrerade adressen.';
$lang['AdminLogin.!error.captcha.invalid'] = 'Den angivna captcha var ogiltig. Vänligen försök igen.';
$lang['AdminLogin.!error.unknown_user'] = 'Användarnamnet känns inte igen eller lösenordet kan inte återställas.';
$lang['AdminLogin.setup.field_submit'] = 'Avsluta';
$lang['AdminLogin.setup.field_enter_key_false'] = 'Jag vill starta en 30-dagars kostnadsfri testperiod';
$lang['AdminLogin.setup.field_enter_key_true'] = 'Jag har en licensnyckel att ange';
$lang['AdminLogin.setup.field_confirm_password'] = 'Bekräfta lösenord';
$lang['AdminLogin.setup.field_password'] = 'Lösenord';
$lang['AdminLogin.setup.field_email'] = 'E-postadress';
$lang['AdminLogin.setup.field_username'] = 'Användarnamn';
$lang['AdminLogin.setup.field_last_name'] = 'Efternamn';
$lang['AdminLogin.setup.field_first_name'] = 'Förnamn';
$lang['AdminLogin.setup.heading_create_account'] = 'Skapa ditt personalkonto';
