...
$lang['AdminSystemAi.!error.key_already_exists'] = 'En API-nyckel har redan genererats för din Blesta AI-prenumeration och kan inte hämtas igen. Återkalla den befintliga nyckeln på sidan ”Hantera AI” för din tjänst på account.blesta.com och försök sedan igen.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s krediter per 1 000 tokens)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Ditt användarnamn på account.blesta.com och din Blesta-licensnyckel kommer att användas för att verifiera din licens och automatiskt hämta en ny Blesta AI-API-nyckel. Om en nyckel redan har genererats måste den först återkallas på sidan ”Hantera AI” för din tjänst på account.blesta.com innan en ny nyckel kan utfärdas.';
