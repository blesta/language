...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Вече е генериран API ключ за вашия абонамент за Blesta AI и той не може да бъде възстановен. Моля, отменете съществуващия ключ от страницата „Управление на AI“ за вашата услуга на адрес account.blesta.com, след което опитайте отново.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s кредита за всеки 1 000 токена)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Потребителското ви име в account.blesta.com и лицензионният ви ключ за Blesta ще бъдат използвани за проверка на валидността на лиценза ви и за автоматично извличане на нов ключ за Blesta AI API. Ако вече е генериран ключ, той трябва първо да бъде отменен от страницата „Управление на AI“ за вашата услуга в account.blesta.com, преди да може да бъде издаден нов ключ.';
