...
$lang['Transactions.!error.amount.applied'] = 'El importe de la transacción no puede ser inferior al importe ya aplicado a las facturas. Primero, desaplica la transacción de una o varias facturas.';
$lang['Transactions.!error.amount.format'] = 'El importe debe ser un número.';
$lang['Transactions.!error.amounts.applied'] = 'No se han podido aplicar los valores de «Importe a pagar» a las facturas indicadas. Inténtalo de nuevo.';
