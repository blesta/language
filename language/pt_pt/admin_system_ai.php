...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Já foi gerada uma chave API para a sua subscrição do Blesta AI e esta não pode ser recuperada novamente. Por favor, revogue a chave existente na página «Gerir IA» do seu serviço em account.blesta.com e, em seguida, tente novamente.';
...
$lang['AdminSystemAi.index.degraded_model'] = 'O modelo atualmente selecionado, «%1$s », já não está disponível. As funcionalidades de IA estão a utilizar temporariamente «%2$s ». Por favor, escolha um novo modelo predefinido abaixo e guarde.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s créditos por cada 1 000 tokens)';
...
$lang['AdminSystemAi.modal.text_info'] = 'O seu nome de utilizador em account.blesta.com e a sua chave de licença do Blesta serão utilizados para validar a sua licença e obter automaticamente uma nova chave da API do Blesta AI. Se já tiver sido gerada uma chave, esta terá de ser revogada na página «Gerir IA» do seu serviço em account.blesta.com antes de poder ser emitida uma nova chave.';
