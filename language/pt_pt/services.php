...
$lang['Services.!error.service_id.has_children'] = 'Este serviço não pode ser excluído porque possui serviços filhos. Cancele ou exclua esses serviços e tente novamente.';
...
$lang['Services.getActions.unsuspend'] = 'Remover Suspensão';
...
$lang['Services.!error.date_canceled.valid'] = 'Você deve definir uma data válida para cancelar este serviço.';
...
$lang['Services.!error.date_canceled.format'] = 'Formato de data de cancelamento inválido.';
$lang['Services.!error.date_suspended.format'] = 'Formato de data de suspensão inválido.';
...
$lang['Services.!error.date_added.format'] = 'Formato de data adicionada inválido.';
...
$lang['Services.!error.coupon_id.valid'] = 'Este cupom não parece ser válido.';
$lang['Services.!error.module_row_id.exists'] = 'ID de linha de módulo inválido.';
$lang['Services.!error.client_id.allowed'] = 'O cliente não pode acessar este pacote.';
...
$lang['Services.!error.id_format.length'] = 'O formato de ID para faturas não pode exceder 64 caracteres.';
...
$lang['Services.!error.move.unpaid_invoices'] = 'O serviço não pode ser transferido para outro cliente porque possui faturas não pagas.';
...
$lang['Services.!error.uncancel.unsupported'] = 'Este serviço não pode ser reativado, pois o módulo não o suporta.';
