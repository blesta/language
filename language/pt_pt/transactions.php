...
$lang['Transactions.status.void'] = 'Anulada';
...
$lang['Transactions.!error.name.empty'] = 'Introduza um nome.';
...
$lang['Transactions.!error.date.format'] = 'A data introduzida é inválida.';
$lang['Transactions.!error.amounts.positive'] = 'Um ou mais valores de Valor a Pagar são negativos. Certifique-se de que cada valor de Valor a Pagar seja zero ou mais.';
...
$lang['Transactions.!error.parent_transaction_id.length'] = 'O comprimento do ID da transação principal não pode exceder 128 caracteres.';
