...
$lang['Transactions.!error.amount.applied'] = 'O valor da transação não pode ser inferior ao valor já aplicado às faturas. Anule primeiro a aplicação da transação numa ou mais faturas.';
$lang['Transactions.!error.amount.format'] = 'O montante deve ser um número.';
$lang['Transactions.!error.amounts.applied'] = 'Não foi possível aplicar os valores de «Montante a pagar» às faturas indicadas. Por favor, tente novamente.';
