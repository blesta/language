...
$lang['Packages.!error.pricing[][id].deletable'] = 'O termo não pode ser removido porque é usado por um ou mais serviços.';
$lang['Packages.!error.pricing[][id].format'] = 'ID de preço do pacote inválido.';
$lang['Packages.!error.pricing[][currency].in_use'] = 'A moeda não pode ser atualizada numa definição de preço que esteja em uso.';
...
$lang['Packages.!error.pricing[][setup_fee].format'] = 'A taxa de configuração deve ser um número.';
...
$lang['Packages.!error.pricing[][period].in_use'] = 'O período não pode ser atualizado numa definição de preço que esteja em uso.';
$lang['Packages.!error.pricing[][period].format'] = 'Tipo de período inválido.';
$lang['Packages.!error.pricing[][term].in_use'] = 'O termo não pode ser atualizado num preço que está em uso.';
...
$lang['Packages.!error.email_content[][lang].empty'] = 'Por favor, insira um idioma.';
$lang['Packages.!error.prorata_cutoff.format'] = 'O dia de corte pró-rata deve estar entre 1 e 28.';
$lang['Packages.!error.prorata_day.format'] = 'O dia pró-rata deve estar entre 1 e 28.';
...
$lang['Packages.!error.upgrades_use_renewal.valid'] = 'Os preços de renovação para upgrades devem ser 1 ou 0.';
...
$lang['Packages.!error.taxable.format'] = 'Tributável deve ser um número.';
$lang['Packages.!error.module_group_client.valid'] = 'Permitir que o Cliente Selecione o Grupo deve ser 1 ou 0.';
$lang['Packages.!error.module_group.format'] = 'Grupo de módulo inválido fornecido.';
...
$lang['Packages.!error.module_id.changed'] = 'O módulo não pode ser alterado porque um ou mais serviços já estão a usar este pacote.';
$lang['Packages.!error.module_id.exists'] = 'Módulo inválido fornecido.';
$lang['Packages.!error.package_id.has_children'] = 'O pacote não pode ser excluído porque um serviço tem serviços secundários.';
$lang['Packages.!error.package_id.exists'] = 'O pacote não pode ser excluído porque um serviço o está a usar atualmente.';
