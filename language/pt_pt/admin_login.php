...
$lang['AdminLogin.!info.otp'] = 'A autenticação de dois factores é necessária para este utilizador. Introduza a sua OTP (Palavra-passe de uso único) abaixo.';
$lang['AdminLogin.!info.reset_password'] = 'Introduza o seu nome de utilizador abaixo e ser-lhe-á enviada por correio eletrónico uma hiperligação sensível ao tempo para que possa definir uma nova palavra-passe.';
$lang['AdminLogin.!success.reset_sent'] = 'Foi enviado um e-mail de confirmação para o endereço registado.';
$lang['AdminLogin.!error.captcha.invalid'] = 'O captcha introduzido é inválido. Por favor, tente novamente.';
$lang['AdminLogin.!error.unknown_user'] = 'Esse nome de utilizador não é reconhecido ou a palavra-passe não pode ser reposta.';
$lang['AdminLogin.setup.field_submit'] = 'Acabamento';
$lang['AdminLogin.setup.field_enter_key_false'] = 'Quero iniciar uma avaliação gratuita de 30 dias';
$lang['AdminLogin.setup.field_enter_key_true'] = 'Tenho uma chave de licença para introduzir';
$lang['AdminLogin.setup.field_confirm_password'] = 'Confirmar a palavra-passe';
$lang['AdminLogin.setup.field_password'] = 'Palavra-passe';
$lang['AdminLogin.setup.field_email'] = 'Endereço de correio eletrónico';
$lang['AdminLogin.setup.field_username'] = 'Nome de utilizador';
$lang['AdminLogin.setup.field_last_name'] = 'Apelido';
$lang['AdminLogin.setup.field_first_name'] = 'Nome próprio';
$lang['AdminLogin.setup.heading_create_account'] = 'Criar a sua conta Pessoal';
