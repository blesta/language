...
$lang['AdminReports.index.field_submit'] = 'Exportar'; // Changed from 'Exportação' (noun) to 'Exportar' (verb)
...
$lang['AdminReports.index.page_title'] = 'Relatórios de faturação'; // Changed from 'faturamento' to 'faturação'
