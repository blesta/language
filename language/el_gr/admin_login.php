...
$lang['AdminLogin.!info.otp'] = 'Για αυτόν τον χρήστη απαιτείται έλεγχος ταυτότητας δύο παραγόντων. Παρακαλούμε εισάγετε τον κωδικό πρόσβασης μιας χρήσης (OTP) παρακάτω.';
$lang['AdminLogin.!info.reset_password'] = 'Πληκτρολογήστε το όνομα χρήστη σας παρακάτω και θα σας αποσταλεί με email ένας σύνδεσμος για να μπορέσετε να ορίσετε έναν νέο κωδικό πρόσβασης.';
$lang['AdminLogin.!success.reset_sent'] = 'Ένα email επιβεβαίωσης έχει σταλεί στη διεύθυνση που έχετε καταγράψει.';
$lang['AdminLogin.!error.captcha.invalid'] = 'Το captcha που εισήχθη ήταν άκυρο. Παρακαλώ προσπαθήστε ξανά.';
$lang['AdminLogin.!error.unknown_user'] = 'Αυτό το όνομα χρήστη δεν αναγνωρίζεται ή ο κωδικός πρόσβασης δεν μπορεί να επαναφερθεί.';
$lang['AdminLogin.setup.field_submit'] = 'Τέλος';
$lang['AdminLogin.setup.field_enter_key_false'] = 'Θέλω να ξεκινήσω μια δωρεάν δοκιμή 30 ημερών';
$lang['AdminLogin.setup.field_enter_key_true'] = 'Έχω ένα κλειδί άδειας χρήσης για εισαγωγή';
$lang['AdminLogin.setup.field_confirm_password'] = 'Επιβεβαίωση κωδικού πρόσβασης';
$lang['AdminLogin.setup.field_password'] = 'Κωδικός πρόσβασης';
$lang['AdminLogin.setup.field_email'] = 'Διεύθυνση ηλεκτρονικού ταχυδρομείου';
$lang['AdminLogin.setup.field_username'] = 'Όνομα χρήστη';
$lang['AdminLogin.setup.field_last_name'] = 'Επώνυμο';
$lang['AdminLogin.setup.field_first_name'] = 'Όνομα';
$lang['AdminLogin.setup.heading_create_account'] = 'Δημιουργήστε το λογαριασμό σας Προσωπικό';
