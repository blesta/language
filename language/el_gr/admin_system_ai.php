...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Έχει ήδη δημιουργηθεί ένα κλειδί API για τη συνδρομή σας στο Blesta AI και δεν είναι δυνατή η εκ νέου ανάκτησή του. Παρακαλούμε να ανακαλέσετε το υπάρχον κλειδί από τη σελίδα «Διαχείριση AI» της υπηρεσίας σας στη διεύθυνση account.blesta.com και, στη συνέχεια, δοκιμάστε ξανά.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s credits ανά 1K tokens)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Το όνομα χρήστη σας στο account.blesta.com και ο κωδικός άδειας χρήσης του Blesta θα χρησιμοποιηθούν για την επικύρωση της άδειας χρήσης σας και την αυτόματη λήψη ενός νέου κλειδιού API του Blesta AI. Εάν έχει ήδη δημιουργηθεί κάποιο κλειδί, θα πρέπει πρώτα να ανακληθεί από τη σελίδα «Διαχείριση AI» της υπηρεσίας σας στο account.blesta.com, προτού να εκδοθεί ένα νέο κλειδί.';
