...
$lang['Transactions.!error.amount.applied'] = '거래 금액은 이미 청구서에 적용된 금액보다 적을 수 없습니다. 먼저 하나 이상의 청구서에서 해당 거래를 취소하십시오.';
$lang['Transactions.!error.amount.format'] = '금액은 숫자여야 합니다.';
$lang['Transactions.!error.amounts.applied'] = '지정된 청구서에 ‘지급 금액’ 값을 적용할 수 없습니다. 다시 시도해 주십시오.';
