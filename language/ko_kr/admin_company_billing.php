...
$lang['AdminCompanyBilling.!tooltip.suspend_services_days_after_due'] = '서비스 청구서가 만기된 후 서비스 이용이 정지되기까지 기다려야 하는 일수입니다. “당일”을 선택한 경우, ‘자동화’ 설정에서 청구서 생성 작업이 서비스 정지 작업보다 먼저 실행될 때에만 청구서 만기일에 서비스가 정지됩니다.';
