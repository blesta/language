...
$lang['AdminSystemAi.modal.text_info'] = 'account.blesta.com 사용자 아이디와 Blesta 라이선스 키는 라이선스의 유효성을 검사하고 새 Blesta AI API 키를 자동으로 가져오는 데 사용됩니다. 이미 생성된 키가 있는 경우 해당 키는 해지되고 새 키가 발급됩니다.';
