...
$lang['Invoices.!error.invoice_ids.match'] = '견적 송장은 다른 견적 송장과만 병합할 수 있으며, 유효한 송장은 다른 유효한 송장과만 병합할 수 있습니다.';
...
$lang['Invoices.!line_item.service_option_prorated_addition_qty_date'] = '↳ %1$s 의 일할 계산된 추가분 %2$s× %3$s (%4$s - %5$s)';
...
$lang['Invoices.!line_item.service_option_prorated_addition_text_date'] = '↳ %1$s 의 일할 계산된 추가분 (%2$s - %3$s)';
$lang['Invoices.!line_item.service_option_prorated_addition_text_onetime'] = '일할 계산된 %1$s 추가';
$lang['Invoices.!line_item.service_option_prorated_upgrade'] = '↳ %2$s 에서 %1$s 로의 일할 계산된 업그레이드 %3$s';
$lang['Invoices.!line_item.service_option_prorated_upgrade_date'] = '↳ %1$s 을 %2$s 에서 %3$s 로 일할 계산 업그레이드 (%4$s - %5$s)';
$lang['Invoices.!line_item.service_option_prorated_upgrade_onetime'] = '↳ %2$s 에서 %1$s 로의 일할 계산된 업그레이드 %3$s';
