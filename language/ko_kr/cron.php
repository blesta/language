...
$lang['Cron.addpaidpendingservices.service_error'] = '클라이언트 #%2$s 의 보류 중인 서비스 #%1$s 를 활성화할 수 없습니다.';
$lang['Cron.addpaidpendingservices.service_success'] = '클라이언트 #%2$s의 보류 중인 서비스 #%1$s가 이제 활성화되었습니다.';
$lang['Cron.applycredits.apply_failed'] = '고객 번호%1$s 에 대해 보류 중인 크레딧을 적용할 수 없습니다.';
$lang['Cron.applycredits.apply_none'] = '크레딧이 적용될 수 있는 인보이스는 없습니다.';
$lang['Cron.applycredits.apply_success'] = '고객 번호%2$s 에 대한 거래 %1$s 의 미처리 크레딧을 청구서 번호%3$s 에 %4$s 금액으로 성공적으로 적용했습니다.';
...
$lang['Cron.autodebitinvoices.charge_attempt'] = '고객 번호%1$s 에 대한 미결제 청구서 전액인 %2$s 을 자동 이체하려고 합니다.';
...
$lang['Cron.cancelscheduledservices.cancel_error'] = '클라이언트 #%2$s 에서 요청한 서비스 #%1$s 를 취소할 수 없습니다.';
$lang['Cron.cancelscheduledservices.cancel_success'] = '클라이언트 #%2$s 의 서비스 #%1$s 이 취소되었습니다.';
