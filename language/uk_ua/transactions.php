...
$lang['Transactions.!error.amount.applied'] = 'Сума транзакції не може бути меншою за суму, яка вже була зарахована за рахунками-фактурами. Спочатку скасуйте зарахування транзакції за одним або кількома рахунками-фактурами.';
$lang['Transactions.!error.amount.format'] = 'Сума повинна бути числом.';
$lang['Transactions.!error.amounts.applied'] = 'Значення «Сума до сплати» не вдалося застосувати до вказаних рахунків-фактур. Спробуйте ще раз.';
