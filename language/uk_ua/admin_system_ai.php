...
$lang['AdminSystemAi.!error.key_already_exists'] = 'Для вашої підписки на Blesta AI вже було згенеровано ключ API, і його неможливо отримати ще раз. Будь ласка, скасуйте діючий ключ на сторінці «Управління AI» для вашої служби на сайті account.blesta.com, а потім спробуйте ще раз.';
...
$lang['AdminSystemAi.index.model_pricing'] = '(%1$s / %2$s кредитів за 1 тис. токенів)';
...
$lang['AdminSystemAi.modal.text_info'] = 'Ваше ім’я користувача на сайті account.blesta.com та ваш ліцензійний ключ Blesta будуть використані для перевірки вашої ліцензії та автоматичного отримання нового ключа API Blesta AI. Якщо ключ уже було згенеровано, його спочатку потрібно скасувати на сторінці «Управління AI» вашої служби на сайті account.blesta.com, перш ніж можна буде видати новий ключ.';
