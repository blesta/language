...
$lang['Invoices.!line_item.service_option_prorated_upgrade'] = '↳ Пропорційне оновлення « %1$s » з « %2$s » до %3$s';
$lang['Invoices.!line_item.service_option_prorated_upgrade_date'] = '↳ Пропорційне оновлення « %1$s » з « %2$s » до « %3$s » (%4$s - %5$s)';
$lang['Invoices.!line_item.service_option_prorated_upgrade_onetime'] = '↳ Пропорційне оновлення « %1$s » з « %2$s » до %3$s';
