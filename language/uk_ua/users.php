...
$lang['Users.!error.clients.exist'] = 'Користувача не можна видалити, оскільки за ним закріплено принаймні одного клієнта.';
$lang['Users.!error.current_password.matches'] = 'Неправильний пароль.';
$lang['Users.!error.new_password.format'] = 'Будь ласка, введіть пароль довжиною не менше %1$s символів.';
...
$lang['Users.!error.new_password.matches'] = 'Паролі не збігаються.';
$lang['Users.!error.otp.auth'] = 'Введений одноразовий пароль є недійсним. Максимальна довжина - 16 символів';
...
$lang['Users.!error.recovery_email.format'] = 'Неправильна адреса електронної пошти для відновлення.';
$lang['Users.!error.two_factor_key.format'] = 'Невірний двофакторний ключ.';
$lang['Users.!error.two_factor_mode.format'] = 'Неправильний двофакторний режим.';
$lang['Users.!error.user_id.exists'] = 'Неправильний ідентифікатор користувача.';
$lang['Users.!error.username.attempts'] = 'Виявлено занадто багато невдалих спроб входу.';
$lang['Users.!error.username.auth'] = 'Не знайдено збігів для цієї комбінації користувача/пароля.';
$lang['Users.!error.username.company'] = 'Ви не авторизовані для входу в систему в цьому місці.';
